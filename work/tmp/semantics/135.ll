...
if.else.i:
  ...
  %phitmp = icmp eq i32 %0, 0, !dbg !1454
  br i1 %phitmp, label %if.end, label %if.then, !dbg !1455
...
if.else.i8:
  ...
  %phitmp = icmp slt i32 %0, 0, !dbg !1623
  br i1 %phitmp, label %if.end, label %if.then, !dbg !1624
...
MI11rf_xpr_read.exit:
  ...
  %cmp = icmp sgt i32 %0, 0, !dbg !1639
  br i1 %cmp, label %if.end, label %if.then, !dbg !1640
...
MI11rf_xpr_read.exit9:
  ...
  %cmp = icmp sgt i32 %0, %1, !dbg !1657
  br i1 %cmp, label %if.end, label %if.then, !dbg !1658
...
if.else.i8:
  ...
  %phitmp = icmp eq i32 %0, 0, !dbg !1713
  br i1 %phitmp, label %if.end, label %if.then, !dbg !1714
