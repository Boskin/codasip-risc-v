...
if.else.i12:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !619
...
MI11rf_xpr_read.exit:
  ...
  br i1 %cmp26.i, label %if.then, label %if.end, !dbg !637
...
MI11rf_xpr_read.exit13:
  ...
  br i1 %cmp26.i, label %if.then, label %if.end, !dbg !656
...
if.else.i12:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !728
...
if.else.i12:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !776
...
MI11rf_xpr_read.exit:
  ...
  br i1 %cmp44.i, label %if.then, label %if.end, !dbg !793
...
MI11rf_xpr_read.exit13:
  ...
  br i1 %cmp44.i, label %if.then, label %if.end, !dbg !812
...
MI11rf_xpr_read.exit13:
  ...
  br i1 %cmp50.i, label %if.then, label %if.end, !dbg !869
...
if.else.i:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1437

if.then:                                          ; preds = %if.else.i
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1438
  %shr = ashr i13 %call, 1, !dbg !1439
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1440
  %conv4 = sext i13 %shr to i32, !dbg !1441
  %shl = shl nsw i32 %conv4, 1, !dbg !1442
  %add = add i32 %1, -4, !dbg !1443
  %sub5 = add i32 %add, %shl, !dbg !1444
  tail call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !1445
...
if.else.i:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1455

if.then:                                          ; preds = %if.else.i
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1456
  %shr = ashr i13 %call, 1, !dbg !1457
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1458
  %conv4 = sext i13 %shr to i32, !dbg !1459
  %shl = shl nsw i32 %conv4, 1, !dbg !1460
  %add = add i32 %1, -4, !dbg !1461
  %sub5 = add i32 %add, %shl, !dbg !1462
  tail call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !1463
...
if.else.i:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1482

if.then:                                          ; preds = %if.else.i
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1483
  %shr = ashr i13 %call, 1, !dbg !1484
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1485
  %conv4 = sext i13 %shr to i32, !dbg !1486
  %shl = shl nsw i32 %conv4, 1, !dbg !1487
  %add = add i32 %1, -4, !dbg !1488
  %sub5 = add i32 %add, %shl, !dbg !1489
  tail call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !1490
...
if.else.i:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1509

if.then:                                          ; preds = %if.else.i
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1510
  %shr = ashr i13 %call, 1, !dbg !1511
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1512
  %conv4 = sext i13 %shr to i32, !dbg !1513
  %shl = shl nsw i32 %conv4, 1, !dbg !1514
  %add = add i32 %1, -4, !dbg !1515
  %sub5 = add i32 %add, %shl, !dbg !1516
  tail call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !1517
...
if.else.i:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1527

if.then:                                          ; preds = %if.else.i
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1528
  %shr = ashr i13 %call, 1, !dbg !1529
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1530
  %conv4 = sext i13 %shr to i32, !dbg !1531
  %shl = shl nsw i32 %conv4, 1, !dbg !1532
  %add = add i32 %1, -4, !dbg !1533
  %sub5 = add i32 %add, %shl, !dbg !1534
  tail call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !1535
...
if.else.i:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1545

if.then:                                          ; preds = %if.else.i
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1546
  %shr = ashr i13 %call, 1, !dbg !1547
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1548
  %conv4 = sext i13 %shr to i32, !dbg !1549
  %shl = shl nsw i32 %conv4, 1, !dbg !1550
  %add = add i32 %1, -4, !dbg !1551
  %sub5 = add i32 %add, %shl, !dbg !1552
  tail call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !1553
...
if.else.i8:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1563

if.then:                                          ; preds = %if.else.i8
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1564
  %shr = ashr i13 %call, 1, !dbg !1565
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1566
  %conv5 = sext i13 %shr to i32, !dbg !1567
  %shl = shl nsw i32 %conv5, 1, !dbg !1568
  %add = add i32 %1, -4, !dbg !1569
  %sub6 = add i32 %add, %shl, !dbg !1570
  tail call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !1571
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1580
  %shr = ashr i13 %call, 1, !dbg !1581
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1582
  %conv5 = sext i13 %shr to i32, !dbg !1583
  %shl = shl nsw i32 %conv5, 1, !dbg !1584
  %add = add i32 %1, -4, !dbg !1585
  %sub6 = add i32 %add, %shl, !dbg !1586
  tail call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !1587
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit9
  %call = tail call i13 @codasip_immread_int13(i32 2) #5, !dbg !1598
  %shr = ashr i13 %call, 1, !dbg !1599
  %2 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1600
  %conv7 = sext i13 %shr to i32, !dbg !1601
  %shl = shl nsw i32 %conv7, 1, !dbg !1602
  %add = add i32 %2, -4, !dbg !1603
  %sub8 = add i32 %add, %shl, !dbg !1604
  tail call void @llvm.br.anyint.i32(i32 %sub8, i1 true), !dbg !1605
...
if.else.i8:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1624

if.then:                                          ; preds = %if.else.i8
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1625
  %shr = ashr i13 %call, 1, !dbg !1626
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1627
  %conv5 = sext i13 %shr to i32, !dbg !1628
  %shl = shl nsw i32 %conv5, 1, !dbg !1629
  %add = add i32 %1, -4, !dbg !1630
  %sub6 = add i32 %add, %shl, !dbg !1631
  tail call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !1632
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1641
  %shr = ashr i13 %call, 1, !dbg !1642
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1643
  %conv5 = sext i13 %shr to i32, !dbg !1644
  %shl = shl nsw i32 %conv5, 1, !dbg !1645
  %add = add i32 %1, -4, !dbg !1646
  %sub6 = add i32 %add, %shl, !dbg !1647
  tail call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !1648
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit9
  %call = tail call i13 @codasip_immread_int13(i32 2) #5, !dbg !1659
  %shr = ashr i13 %call, 1, !dbg !1660
  %2 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1661
  %conv7 = sext i13 %shr to i32, !dbg !1662
  %shl = shl nsw i32 %conv7, 1, !dbg !1663
  %add = add i32 %2, -4, !dbg !1664
  %sub8 = add i32 %add, %shl, !dbg !1665
  tail call void @llvm.br.anyint.i32(i32 %sub8, i1 true), !dbg !1666
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1679
  %shr = ashr i13 %call, 1, !dbg !1680
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1681
  %conv5 = sext i13 %shr to i32, !dbg !1682
  %shl = shl nsw i32 %conv5, 1, !dbg !1683
  %add = add i32 %1, -4, !dbg !1684
  %sub6 = add i32 %add, %shl, !dbg !1685
  tail call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !1686
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit9
  %call = tail call i13 @codasip_immread_int13(i32 2) #5, !dbg !1697
  %shr = ashr i13 %call, 1, !dbg !1698
  %2 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1699
  %conv7 = sext i13 %shr to i32, !dbg !1700
  %shl = shl nsw i32 %conv7, 1, !dbg !1701
  %add = add i32 %2, -4, !dbg !1702
  %sub8 = add i32 %add, %shl, !dbg !1703
  tail call void @llvm.br.anyint.i32(i32 %sub8, i1 true), !dbg !1704
...
if.else.i8:
  ...
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1714

if.then:                                          ; preds = %if.else.i8
  %call = tail call i13 @codasip_immread_int13(i32 1) #5, !dbg !1715
  %shr = ashr i13 %call, 1, !dbg !1716
  %1 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1717
  %conv5 = sext i13 %shr to i32, !dbg !1718
  %shl = shl nsw i32 %conv5, 1, !dbg !1719
  %add = add i32 %1, -4, !dbg !1720
  %sub6 = add i32 %add, %shl, !dbg !1721
  tail call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !1722
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit9
  %call = tail call i13 @codasip_immread_int13(i32 2) #5, !dbg !1735
  %shr = ashr i13 %call, 1, !dbg !1736
  %2 = tail call i32 @llvm.getnextpc.anyint.i32(), !dbg !1737
  %conv7 = sext i13 %shr to i32, !dbg !1738
  %shl = shl nsw i32 %conv7, 1, !dbg !1739
  %add = add i32 %2, -4, !dbg !1740
  %sub8 = add i32 %add, %shl, !dbg !1741
  tail call void @llvm.br.anyint.i32(i32 %sub8, i1 true), !dbg !1742
...
!1437 = !DILocation(line: 673, column: 9, scope: !1433)
!1438 = !DILocation(line: 685, column: 76, scope: !1433)
!1439 = !DILocation(line: 685, column: 114, scope: !1433)
!1440 = !DILocation(line: 675, column: 21, scope: !1433)
!1441 = !DILocation(line: 675, column: 30, scope: !1433)
!1442 = !DILocation(line: 675, column: 97, scope: !1433)
!1443 = !DILocation(line: 675, column: 26, scope: !1433)
!1444 = !DILocation(line: 675, column: 113, scope: !1433)
!1445 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1446)
!1446 = distinct !DILocation(line: 675, column: 9, scope: !1433)
...
!1455 = !DILocation(line: 694, column: 9, scope: !1451)
!1456 = !DILocation(line: 706, column: 76, scope: !1451)
!1457 = !DILocation(line: 706, column: 114, scope: !1451)
!1458 = !DILocation(line: 696, column: 21, scope: !1451)
!1459 = !DILocation(line: 696, column: 30, scope: !1451)
!1460 = !DILocation(line: 696, column: 97, scope: !1451)
!1461 = !DILocation(line: 696, column: 26, scope: !1451)
!1462 = !DILocation(line: 696, column: 113, scope: !1451)
!1463 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1464)
!1464 = distinct !DILocation(line: 696, column: 9, scope: !1451)
...
!1482 = !DILocation(line: 715, column: 9, scope: !1478)
!1483 = !DILocation(line: 727, column: 76, scope: !1478)
!1484 = !DILocation(line: 727, column: 114, scope: !1478)
!1485 = !DILocation(line: 717, column: 21, scope: !1478)
!1486 = !DILocation(line: 717, column: 30, scope: !1478)
!1487 = !DILocation(line: 717, column: 97, scope: !1478)
!1488 = !DILocation(line: 717, column: 26, scope: !1478)
!1489 = !DILocation(line: 717, column: 113, scope: !1478)
!1490 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1491)
!1491 = distinct !DILocation(line: 717, column: 9, scope: !1478)
...
!1509 = !DILocation(line: 736, column: 9, scope: !1505)
!1510 = !DILocation(line: 748, column: 76, scope: !1505)
!1511 = !DILocation(line: 748, column: 114, scope: !1505)
!1512 = !DILocation(line: 738, column: 21, scope: !1505)
!1513 = !DILocation(line: 738, column: 30, scope: !1505)
!1514 = !DILocation(line: 738, column: 97, scope: !1505)
!1515 = !DILocation(line: 738, column: 26, scope: !1505)
!1516 = !DILocation(line: 738, column: 113, scope: !1505)
!1517 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1518)
!1518 = distinct !DILocation(line: 738, column: 9, scope: !1505)
...
!1527 = !DILocation(line: 757, column: 9, scope: !1523)
!1528 = !DILocation(line: 769, column: 76, scope: !1523)
!1529 = !DILocation(line: 769, column: 114, scope: !1523)
!1530 = !DILocation(line: 759, column: 21, scope: !1523)
!1531 = !DILocation(line: 759, column: 30, scope: !1523)
!1532 = !DILocation(line: 759, column: 97, scope: !1523)
!1533 = !DILocation(line: 759, column: 26, scope: !1523)
!1534 = !DILocation(line: 759, column: 113, scope: !1523)
!1535 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1536)
!1536 = distinct !DILocation(line: 759, column: 9, scope: !1523)
...
!1545 = !DILocation(line: 778, column: 9, scope: !1541)
!1546 = !DILocation(line: 790, column: 76, scope: !1541)
!1547 = !DILocation(line: 790, column: 114, scope: !1541)
!1548 = !DILocation(line: 780, column: 21, scope: !1541)
!1549 = !DILocation(line: 780, column: 30, scope: !1541)
!1550 = !DILocation(line: 780, column: 97, scope: !1541)
!1551 = !DILocation(line: 780, column: 26, scope: !1541)
!1552 = !DILocation(line: 780, column: 113, scope: !1541)
!1553 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1554)
!1554 = distinct !DILocation(line: 780, column: 9, scope: !1541)
...
!1563 = !DILocation(line: 800, column: 9, scope: !1559)
!1564 = !DILocation(line: 812, column: 76, scope: !1559)
!1565 = !DILocation(line: 812, column: 114, scope: !1559)
!1566 = !DILocation(line: 802, column: 21, scope: !1559)
!1567 = !DILocation(line: 802, column: 30, scope: !1559)
!1568 = !DILocation(line: 802, column: 97, scope: !1559)
!1569 = !DILocation(line: 802, column: 26, scope: !1559)
!1570 = !DILocation(line: 802, column: 113, scope: !1559)
!1571 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1572)
!1572 = distinct !DILocation(line: 802, column: 9, scope: !1559)
...
!1579 = !DILocation(line: 800, column: 9, scope: !1575)
!1580 = !DILocation(line: 812, column: 76, scope: !1575)
!1581 = !DILocation(line: 812, column: 114, scope: !1575)
!1582 = !DILocation(line: 802, column: 21, scope: !1575)
!1583 = !DILocation(line: 802, column: 30, scope: !1575)
!1584 = !DILocation(line: 802, column: 97, scope: !1575)
!1585 = !DILocation(line: 802, column: 26, scope: !1575)
!1586 = !DILocation(line: 802, column: 113, scope: !1575)
!1587 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1588)
!1588 = distinct !DILocation(line: 802, column: 9, scope: !1575)
...
!1597 = !DILocation(line: 800, column: 9, scope: !1591)
!1598 = !DILocation(line: 812, column: 76, scope: !1591)
!1599 = !DILocation(line: 812, column: 114, scope: !1591)
!1600 = !DILocation(line: 802, column: 21, scope: !1591)
!1601 = !DILocation(line: 802, column: 30, scope: !1591)
!1602 = !DILocation(line: 802, column: 97, scope: !1591)
!1603 = !DILocation(line: 802, column: 26, scope: !1591)
!1604 = !DILocation(line: 802, column: 113, scope: !1591)
!1605 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1606)
!1606 = distinct !DILocation(line: 802, column: 9, scope: !1591)
...
!1624 = !DILocation(line: 822, column: 9, scope: !1620)
!1625 = !DILocation(line: 834, column: 76, scope: !1620)
!1626 = !DILocation(line: 834, column: 114, scope: !1620)
!1627 = !DILocation(line: 824, column: 21, scope: !1620)
!1628 = !DILocation(line: 824, column: 30, scope: !1620)
!1629 = !DILocation(line: 824, column: 97, scope: !1620)
!1630 = !DILocation(line: 824, column: 26, scope: !1620)
!1631 = !DILocation(line: 824, column: 113, scope: !1620)
!1632 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1633)
!1633 = distinct !DILocation(line: 824, column: 9, scope: !1620)
...
!1640 = !DILocation(line: 822, column: 9, scope: !1636)
!1641 = !DILocation(line: 834, column: 76, scope: !1636)
!1642 = !DILocation(line: 834, column: 114, scope: !1636)
!1643 = !DILocation(line: 824, column: 21, scope: !1636)
!1644 = !DILocation(line: 824, column: 30, scope: !1636)
!1645 = !DILocation(line: 824, column: 97, scope: !1636)
!1646 = !DILocation(line: 824, column: 26, scope: !1636)
!1647 = !DILocation(line: 824, column: 113, scope: !1636)
!1648 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1649)
!1649 = distinct !DILocation(line: 824, column: 9, scope: !1636)
...
!1658 = !DILocation(line: 822, column: 9, scope: !1652)
!1659 = !DILocation(line: 834, column: 76, scope: !1652)
!1660 = !DILocation(line: 834, column: 114, scope: !1652)
!1661 = !DILocation(line: 824, column: 21, scope: !1652)
!1662 = !DILocation(line: 824, column: 30, scope: !1652)
!1663 = !DILocation(line: 824, column: 97, scope: !1652)
!1664 = !DILocation(line: 824, column: 26, scope: !1652)
!1665 = !DILocation(line: 824, column: 113, scope: !1652)
!1666 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1667)
!1667 = distinct !DILocation(line: 824, column: 9, scope: !1652)
...
!1678 = !DILocation(line: 844, column: 9, scope: !1674)
!1679 = !DILocation(line: 856, column: 76, scope: !1674)
!1680 = !DILocation(line: 856, column: 114, scope: !1674)
!1681 = !DILocation(line: 846, column: 21, scope: !1674)
!1682 = !DILocation(line: 846, column: 30, scope: !1674)
!1683 = !DILocation(line: 846, column: 97, scope: !1674)
!1684 = !DILocation(line: 846, column: 26, scope: !1674)
!1685 = !DILocation(line: 846, column: 113, scope: !1674)
!1686 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1687)
!1687 = distinct !DILocation(line: 846, column: 9, scope: !1674)
...
!1696 = !DILocation(line: 844, column: 9, scope: !1690)
!1697 = !DILocation(line: 856, column: 76, scope: !1690)
!1698 = !DILocation(line: 856, column: 114, scope: !1690)
!1699 = !DILocation(line: 846, column: 21, scope: !1690)
!1700 = !DILocation(line: 846, column: 30, scope: !1690)
!1701 = !DILocation(line: 846, column: 97, scope: !1690)
!1702 = !DILocation(line: 846, column: 26, scope: !1690)
!1703 = !DILocation(line: 846, column: 113, scope: !1690)
!1704 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1705)
!1705 = distinct !DILocation(line: 846, column: 9, scope: !1690)
...
!1714 = !DILocation(line: 866, column: 9, scope: !1710)
!1715 = !DILocation(line: 878, column: 76, scope: !1710)
!1716 = !DILocation(line: 878, column: 114, scope: !1710)
!1717 = !DILocation(line: 868, column: 21, scope: !1710)
!1718 = !DILocation(line: 868, column: 30, scope: !1710)
!1719 = !DILocation(line: 868, column: 97, scope: !1710)
!1720 = !DILocation(line: 868, column: 26, scope: !1710)
!1721 = !DILocation(line: 868, column: 113, scope: !1710)
!1722 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1723)
!1723 = distinct !DILocation(line: 868, column: 9, scope: !1710)
...
!1734 = !DILocation(line: 866, column: 9, scope: !1728)
!1735 = !DILocation(line: 878, column: 76, scope: !1728)
!1736 = !DILocation(line: 878, column: 114, scope: !1728)
!1737 = !DILocation(line: 868, column: 21, scope: !1728)
!1738 = !DILocation(line: 868, column: 30, scope: !1728)
!1739 = !DILocation(line: 868, column: 97, scope: !1728)
!1740 = !DILocation(line: 868, column: 26, scope: !1728)
!1741 = !DILocation(line: 868, column: 113, scope: !1728)
!1742 = !DILocation(line: 49, column: 6, scope: !558, inlinedAt: !1743)
!1743 = distinct !DILocation(line: 868, column: 9, scope: !1728)
