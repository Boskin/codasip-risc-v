...
entry:
  ...
  %0 = call i32 @llvm.regread.anyint.i32(i32 35, i32 6), !dbg !15
  %phitmp = zext i32 %0 to i64, !dbg !20
  %call1 = tail call i32 @codasip_syscall(i64 %phitmp) #5, !dbg !21
  ret void, !dbg !23
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !27
  %conv.i13 = and i32 1, 31, !dbg !28
...
if.else.i18:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !32
  %2 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !32
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !36
  %conv.i = and i32 1, 31, !dbg !37
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !39
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !40

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !41
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !41
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !45
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !46
  %conv.i = and i32 2, 31, !dbg !47
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !49
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !50

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !51
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !51
  br label %MI11rf_xpr_read.exit, !dbg !52

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i13 = and i32 1, 31, !dbg !53
...
if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !57
  %5 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !57
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !61
  %conv.i1 = and i32 1, 31, !dbg !62
...
if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !67
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !71
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !72
  %conv.i13 = and i32 1, 31, !dbg !73
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !75
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !76

if.else.i18:                                      ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !77
  %3 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !77
  br label %MI11rf_xpr_read.exit19, !dbg !78

MI11rf_xpr_read.exit19:                           ; preds = %entry, %if.else.i18
  %storemerge20 = phi i32 [ %3, %if.else.i18 ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !79
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !83
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !87
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !88
  %conv.i = and i32 1, 31, !dbg !89
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !91
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !92

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !93
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !93
  br label %MI11rf_xpr_read.exit, !dbg !94

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !95
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !99
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !103
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !104
  %2 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !105
  %conv.i = and i32 2, 31, !dbg !106
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !108
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !109

if.else.i:                                        ; preds = %entry
  %3 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %3, !dbg !110
  %4 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !110
  br label %MI11rf_xpr_read.exit, !dbg !111

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %4, %if.else.i ], [ 0, %entry ]
  %conv.i13 = and i32 1, 31, !dbg !112
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !114
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !115

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !116
  %6 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !116
  br label %MI11rf_xpr_read.exit19, !dbg !117

MI11rf_xpr_read.exit19:                           ; preds = %MI11rf_xpr_read.exit, %if.else.i18
  %storemerge20 = phi i32 [ %6, %if.else.i18 ], [ 0, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 3, 31, !dbg !118
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %7 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %7, !dbg !125
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !131
  %conv.i13 = and i32 1, 31, !dbg !132
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !134
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !135

if.else.i18:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !136
  %2 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !136
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !140
  %conv.i = and i32 1, 31, !dbg !141
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !143
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !144

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !145
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !145
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !149
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !150
  %conv.i = and i32 2, 31, !dbg !151
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !153
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !154

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !155
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !155
  br label %MI11rf_xpr_read.exit, !dbg !156

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i13 = and i32 1, 31, !dbg !157
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !159
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !160

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !161
  %5 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !161
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !165
  %conv.i1 = and i32 1, 31, !dbg !166
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !168
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !169

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !170
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !174
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !175
  %conv.i13 = and i32 1, 31, !dbg !176
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !178
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !179

if.else.i18:                                      ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !180
  %3 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !180
  %phitmp = icmp sgt i32 %3, 0, !dbg !181
  br label %MI11rf_xpr_read.exit19, !dbg !181

MI11rf_xpr_read.exit19:                           ; preds = %entry, %if.else.i18
  %storemerge20 = phi i1 [ %phitmp, %if.else.i18 ], [ false, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !182
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !188
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !192
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !193
  %conv.i = and i32 1, 31, !dbg !194
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !196
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !197

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !198
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !198
  %phitmp = icmp slt i32 %3, 0, !dbg !199
  br label %MI11rf_xpr_read.exit, !dbg !199

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i1 [ %phitmp, %if.else.i ], [ false, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !200
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !206
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !210
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !211
  %2 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !212
  %conv.i = and i32 2, 31, !dbg !213
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !215
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !216

if.else.i:                                        ; preds = %entry
  %3 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %3, !dbg !217
  %4 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !217
  br label %MI11rf_xpr_read.exit, !dbg !218

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %4, %if.else.i ], [ 0, %entry ]
  %conv.i13 = and i32 1, 31, !dbg !219
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !221
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !222

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !223
  %6 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !223
  br label %MI11rf_xpr_read.exit19, !dbg !224

MI11rf_xpr_read.exit19:                           ; preds = %MI11rf_xpr_read.exit, %if.else.i18
  %storemerge20 = phi i32 [ %6, %if.else.i18 ], [ 0, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 3, 31, !dbg !225
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %7 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %7, !dbg !232
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !238
  %conv.i13 = and i32 1, 31, !dbg !239
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !241
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !242

if.else.i18:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !243
  %2 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !243
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !247
  %conv.i = and i32 1, 31, !dbg !248
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !250
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !251

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !252
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !252
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !256
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !257
  %conv.i = and i32 2, 31, !dbg !258
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !260
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !261

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !262
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !262
  br label %MI11rf_xpr_read.exit, !dbg !263

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i13 = and i32 1, 31, !dbg !264
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !266
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !267

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !268
  %5 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !268
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !272
  %conv.i1 = and i32 1, 31, !dbg !273
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !275
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !276

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !277
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !281
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !282
  %conv.i13 = and i32 1, 31, !dbg !283
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !285
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !286

if.else.i18:                                      ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !287
  %3 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !287
  %phitmp = icmp ne i32 %3, 0, !dbg !288
  br label %MI11rf_xpr_read.exit19, !dbg !288

MI11rf_xpr_read.exit19:                           ; preds = %entry, %if.else.i18
  %storemerge20 = phi i1 [ %phitmp, %if.else.i18 ], [ false, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !289
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !295
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !299
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !300
  %conv.i = and i32 1, 31, !dbg !301
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !303
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !304

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !305
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !305
  br label %MI11rf_xpr_read.exit, !dbg !306

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i1 = and i32 2, 31, !dbg !307
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !309
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !310

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !311
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !315
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !316
  %2 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !317
  %conv.i = and i32 2, 31, !dbg !318
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !320
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !321

if.else.i:                                        ; preds = %entry
  %3 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %3, !dbg !322
  %4 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !322
  br label %MI11rf_xpr_read.exit, !dbg !323

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %4, %if.else.i ], [ 0, %entry ]
  %conv.i13 = and i32 1, 31, !dbg !324
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !326
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !327

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !328
  %6 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !328
  br label %MI11rf_xpr_read.exit19, !dbg !329

MI11rf_xpr_read.exit19:                           ; preds = %MI11rf_xpr_read.exit, %if.else.i18
  %storemerge20 = phi i32 [ %6, %if.else.i18 ], [ 0, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 3, 31, !dbg !330
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %7 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %7, !dbg !337
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !343
  %conv.i13 = and i32 1, 31, !dbg !344
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !346
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !347

if.else.i18:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !348
  %2 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !348
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !352
  %conv.i = and i32 1, 31, !dbg !353
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !355
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !356

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !357
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !357
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !361
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !362
  %conv.i = and i32 2, 31, !dbg !363
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !365
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !366

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !367
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !367
  br label %MI11rf_xpr_read.exit, !dbg !368

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i13 = and i32 1, 31, !dbg !369
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !371
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !372

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !373
  %5 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !373
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !377
  %conv.i1 = and i32 1, 31, !dbg !378
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !380
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !381

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !382
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !386
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !387
  %conv.i13 = and i32 1, 31, !dbg !388
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !390
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !391

if.else.i18:                                      ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !392
  %3 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !392
  br label %MI11rf_xpr_read.exit19, !dbg !393

MI11rf_xpr_read.exit19:                           ; preds = %entry, %if.else.i18
  %conv.i1 = and i32 2, 31, !dbg !394
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !396
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !397

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !398
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !402
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !403
  %conv.i = and i32 1, 31, !dbg !404
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !406
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !407

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !408
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !408
  br label %MI11rf_xpr_read.exit, !dbg !409

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i1 = and i32 2, 31, !dbg !410
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !412
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !413

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !414
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !418
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !419
  %2 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !420
  %conv.i = and i32 2, 31, !dbg !421
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !423
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !424

if.else.i:                                        ; preds = %entry
  %3 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %3, !dbg !425
  %4 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !425
  br label %MI11rf_xpr_read.exit, !dbg !426

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %4, %if.else.i ], [ 0, %entry ]
  %conv.i13 = and i32 1, 31, !dbg !427
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !429
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !430

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !431
  %6 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !431
  br label %MI11rf_xpr_read.exit19, !dbg !432

MI11rf_xpr_read.exit19:                           ; preds = %MI11rf_xpr_read.exit, %if.else.i18
  %storemerge20 = phi i32 [ %6, %if.else.i18 ], [ 0, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 3, 31, !dbg !433
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %7 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %7, !dbg !439
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !445
  %conv.i13 = and i32 1, 31, !dbg !446
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !448
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !449

if.else.i18:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !450
  %2 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !450
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !454
  %conv.i = and i32 1, 31, !dbg !455
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !457
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !458

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !459
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !459
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !463
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !464
  %conv.i = and i32 2, 31, !dbg !465
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !467
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !468

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !469
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !469
  br label %MI11rf_xpr_read.exit, !dbg !470

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i13 = and i32 1, 31, !dbg !471
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !473
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !474

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !475
  %5 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !475
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !479
  %conv.i1 = and i32 1, 31, !dbg !480
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !482
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !483

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !484
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !488
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !489
  %conv.i13 = and i32 1, 31, !dbg !490
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !492
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !493

if.else.i18:                                      ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !494
  %3 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !494
  br label %MI11rf_xpr_read.exit19, !dbg !495

MI11rf_xpr_read.exit19:                           ; preds = %entry, %if.else.i18
  %storemerge20 = phi i32 [ %3, %if.else.i18 ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !496
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !498
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !499

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !500
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !504
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !505
  %conv.i = and i32 1, 31, !dbg !506
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !508
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !509

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !510
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !510
  br label %MI11rf_xpr_read.exit, !dbg !511

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !512
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !514
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !515

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !516
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !520
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !521
  %2 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !522
  %conv.i = and i32 2, 31, !dbg !523
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !525
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !526

if.else.i:                                        ; preds = %entry
  %3 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %3, !dbg !527
  %4 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !527
  br label %MI11rf_xpr_read.exit, !dbg !528

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %4, %if.else.i ], [ 0, %entry ]
  %conv.i13 = and i32 1, 31, !dbg !529
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !531
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !532

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !533
  %6 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !533
  br label %MI11rf_xpr_read.exit19, !dbg !534

MI11rf_xpr_read.exit19:                           ; preds = %MI11rf_xpr_read.exit, %if.else.i18
  %storemerge20 = phi i32 [ %6, %if.else.i18 ], [ 0, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 3, 31, !dbg !535
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %7 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %7, !dbg !541
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !547
  %conv.i13 = and i32 1, 31, !dbg !548
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !550
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !551

if.else.i18:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !552
  %2 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !552
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !556
  %conv.i = and i32 1, 31, !dbg !557
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !559
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !560

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !561
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !561
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !565
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !566
  %conv.i = and i32 2, 31, !dbg !567
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !569
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !570

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !571
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !571
  br label %MI11rf_xpr_read.exit, !dbg !572

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i13 = and i32 1, 31, !dbg !573
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !575
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !576

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !577
  %5 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !577
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !581
  %conv.i1 = and i32 1, 31, !dbg !582
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !584
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !585

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !586
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !590
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !591
  %conv.i13 = and i32 1, 31, !dbg !592
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !594
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !595

if.else.i18:                                      ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !596
  %3 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !596
  br label %MI11rf_xpr_read.exit19, !dbg !597

MI11rf_xpr_read.exit19:                           ; preds = %entry, %if.else.i18
  %storemerge20 = phi i32 [ %3, %if.else.i18 ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !598
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !600
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !601

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !602
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !606
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !607
  %conv.i = and i32 1, 31, !dbg !608
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !610
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !611

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !612
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !612
  br label %MI11rf_xpr_read.exit, !dbg !613

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !614
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !616
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !617

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !618
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !622
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !623
  %2 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !624
  %conv.i = and i32 2, 31, !dbg !625
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !627
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !628

if.else.i:                                        ; preds = %entry
  %3 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %3, !dbg !629
  %4 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !629
  br label %MI11rf_xpr_read.exit, !dbg !630

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %4, %if.else.i ], [ 0, %entry ]
  %conv.i13 = and i32 1, 31, !dbg !631
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !633
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !634

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !635
  %6 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !635
  br label %MI11rf_xpr_read.exit19, !dbg !636

MI11rf_xpr_read.exit19:                           ; preds = %MI11rf_xpr_read.exit, %if.else.i18
  %storemerge20 = phi i32 [ %6, %if.else.i18 ], [ 0, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 3, 31, !dbg !637
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %7 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %7, !dbg !643
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !649
  %conv.i13 = and i32 1, 31, !dbg !650
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !652
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !653

if.else.i18:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !654
  %2 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !654
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !658
  %conv.i = and i32 1, 31, !dbg !659
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !661
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !662

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !663
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !663
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !667
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !668
  %conv.i = and i32 2, 31, !dbg !669
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !671
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !672

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !673
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !673
  br label %MI11rf_xpr_read.exit, !dbg !674

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i13 = and i32 1, 31, !dbg !675
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !677
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !678

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !679
  %5 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !679
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !683
  %conv.i1 = and i32 1, 31, !dbg !684
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !686
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !687

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !688
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !692
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !693
  %conv.i13 = and i32 1, 31, !dbg !694
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !696
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !697

if.else.i18:                                      ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !698
  %3 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !698
  br label %MI11rf_xpr_read.exit19, !dbg !699

MI11rf_xpr_read.exit19:                           ; preds = %entry, %if.else.i18
  %conv.i1 = and i32 2, 31, !dbg !700
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !702
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !703

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !704
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !708
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !709
  %conv.i = and i32 1, 31, !dbg !710
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !712
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !713

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !714
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !714
  br label %MI11rf_xpr_read.exit, !dbg !715

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !716
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !718
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !719

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !720
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !724
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !725
  %2 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !726
  %conv.i = and i32 2, 31, !dbg !727
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !729
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !730

if.else.i:                                        ; preds = %entry
  %3 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %3, !dbg !731
  %4 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !731
  br label %MI11rf_xpr_read.exit, !dbg !732

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %4, %if.else.i ], [ 0, %entry ]
  %conv.i13 = and i32 1, 31, !dbg !733
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !735
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !736

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !737
  %6 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !737
  %phitmp = and i32 %6, 31, !dbg !738
  br label %MI11rf_xpr_read.exit19, !dbg !738

MI11rf_xpr_read.exit19:                           ; preds = %MI11rf_xpr_read.exit, %if.else.i18
  %storemerge20 = phi i32 [ %phitmp, %if.else.i18 ], [ 0, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 3, 31, !dbg !739
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %7 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %7, !dbg !745
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !751
  %conv.i13 = and i32 1, 31, !dbg !752
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !754
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !755

if.else.i18:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !756
  %2 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !756
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !760
  %conv.i = and i32 1, 31, !dbg !761
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !763
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !764

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !765
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !765
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !769
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !770
  %conv.i = and i32 2, 31, !dbg !771
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !773
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !774

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !775
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !775
  br label %MI11rf_xpr_read.exit, !dbg !776

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i13 = and i32 1, 31, !dbg !777
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !779
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !780

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !781
  %5 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !781
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !785
  %conv.i1 = and i32 1, 31, !dbg !786
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !788
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !789

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !790
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !794
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !795
  %conv.i13 = and i32 1, 31, !dbg !796
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !798
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !799

if.else.i18:                                      ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !800
  %3 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !800
  br label %MI11rf_xpr_read.exit19, !dbg !801

MI11rf_xpr_read.exit19:                           ; preds = %entry, %if.else.i18
  %conv.i1 = and i32 2, 31, !dbg !802
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !804
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !805

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !806
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !810
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !811
  %conv.i = and i32 1, 31, !dbg !812
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !814
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !815

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !816
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !816
  br label %MI11rf_xpr_read.exit, !dbg !817

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !818
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !820
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !821

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !822
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !826
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !827
  %2 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !828
  %conv.i = and i32 2, 31, !dbg !829
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !831
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !832

if.else.i:                                        ; preds = %entry
  %3 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %3, !dbg !833
  %4 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !833
  br label %MI11rf_xpr_read.exit, !dbg !834

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %4, %if.else.i ], [ 0, %entry ]
  %conv.i13 = and i32 1, 31, !dbg !835
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !837
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !838

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !839
  %6 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !839
  %phitmp = and i32 %6, 31, !dbg !840
  br label %MI11rf_xpr_read.exit19, !dbg !840

MI11rf_xpr_read.exit19:                           ; preds = %MI11rf_xpr_read.exit, %if.else.i18
  %storemerge20 = phi i32 [ %phitmp, %if.else.i18 ], [ 0, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 3, 31, !dbg !841
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %7 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %7, !dbg !847
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !853
  %conv.i13 = and i32 1, 31, !dbg !854
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !856
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !857

if.else.i18:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !858
  %2 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !858
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !862
  %conv.i = and i32 1, 31, !dbg !863
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !865
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !866

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !867
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !867
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !871
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !872
  %conv.i = and i32 2, 31, !dbg !873
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !875
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !876

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !877
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !877
  br label %MI11rf_xpr_read.exit, !dbg !878

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i13 = and i32 1, 31, !dbg !879
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !881
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !882

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !883
  %5 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !883
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !887
  %conv.i1 = and i32 1, 31, !dbg !888
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !890
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !891

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !892
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !896
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !897
  %conv.i13 = and i32 1, 31, !dbg !898
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !900
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !901

if.else.i18:                                      ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !902
  %3 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !902
  br label %MI11rf_xpr_read.exit19, !dbg !903

MI11rf_xpr_read.exit19:                           ; preds = %entry, %if.else.i18
  %storemerge20 = phi i32 [ %3, %if.else.i18 ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !904
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !910
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !914
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !915
  %conv.i = and i32 1, 31, !dbg !916
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !918
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !919

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !920
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !920
  br label %MI11rf_xpr_read.exit, !dbg !921

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !922
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !924
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !925

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !926
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !930
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !931
  %2 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !932
  %conv.i = and i32 2, 31, !dbg !933
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !935
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !936

if.else.i:                                        ; preds = %entry
  %3 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %3, !dbg !937
  %4 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !937
  br label %MI11rf_xpr_read.exit, !dbg !938

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %4, %if.else.i ], [ 0, %entry ]
  %conv.i13 = and i32 1, 31, !dbg !939
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !941
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !942

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !943
  %6 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !943
  br label %MI11rf_xpr_read.exit19, !dbg !944

MI11rf_xpr_read.exit19:                           ; preds = %MI11rf_xpr_read.exit, %if.else.i18
  %storemerge20 = phi i32 [ %6, %if.else.i18 ], [ 0, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 3, 31, !dbg !945
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %7 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %7, !dbg !951
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !957
  %conv.i13 = and i32 1, 31, !dbg !958
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !960
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !961

if.else.i18:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !962
  %2 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !962
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !966
  %conv.i = and i32 1, 31, !dbg !967
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !969
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !970

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !971
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !971
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !975
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !976
  %conv.i = and i32 2, 31, !dbg !977
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !979
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !980

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !981
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !981
  br label %MI11rf_xpr_read.exit, !dbg !982

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %conv.i13 = and i32 1, 31, !dbg !983
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !985
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !986

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !987
  %5 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !987
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !991
  %conv.i1 = and i32 1, 31, !dbg !992
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !994
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !995

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !996
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1000
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1001
  %conv.i13 = and i32 1, 31, !dbg !1002
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !1004
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !1005

if.else.i18:                                      ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1006
  %3 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !1006
  br label %MI11rf_xpr_read.exit19, !dbg !1007

MI11rf_xpr_read.exit19:                           ; preds = %entry, %if.else.i18
  %conv.i1 = and i32 2, 31, !dbg !1008
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1010
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1011

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1012
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1016
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1017
  %conv.i = and i32 1, 31, !dbg !1018
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1020
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1021

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1022
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1022
  br label %MI11rf_xpr_read.exit, !dbg !1023

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !1024
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1026
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1027

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1028
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !1032
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1033
  %2 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1034
  %conv.i = and i32 2, 31, !dbg !1035
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1037
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1038

if.else.i:                                        ; preds = %entry
  %3 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %3, !dbg !1039
  %4 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1039
  br label %MI11rf_xpr_read.exit, !dbg !1040

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %4, %if.else.i ], [ 0, %entry ]
  %conv.i13 = and i32 1, 31, !dbg !1041
  %cmp.i14 = icmp eq i32 %conv.i13, 0, !dbg !1043
  br i1 %cmp.i14, label %MI11rf_xpr_read.exit19, label %if.else.i18, !dbg !1044

if.else.i18:                                      ; preds = %MI11rf_xpr_read.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i17 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !1045
  %6 = load volatile i32, i32* %arrayidx.i17, align 4, !dbg !1045
  %phitmp = and i32 %6, 31, !dbg !1046
  br label %MI11rf_xpr_read.exit19, !dbg !1046

MI11rf_xpr_read.exit19:                           ; preds = %MI11rf_xpr_read.exit, %if.else.i18
  %storemerge20 = phi i32 [ %phitmp, %if.else.i18 ], [ 0, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 3, 31, !dbg !1047
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit19
  ...
  %7 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %7, !dbg !1053
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1059
  %conv.i = and i32 1, 31, !dbg !1060
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1062
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1063

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1064
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1064
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1068
  %conv.i1 = and i32 1, 31, !dbg !1069
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1071
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1072

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1073
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1077
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1078
  %call = tail call i5 @codasip_immread_uint5(i32 2) #4, !dbg !1079
  %conv.i = and i32 1, 31, !dbg !1080
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1082
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1083

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1084
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1084
  br label %MI11rf_xpr_read.exit, !dbg !1085

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !1086
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1093
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1099
  %conv.i = and i32 1, 31, !dbg !1100
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1102
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1103

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1104
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1104
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1108
  %conv.i1 = and i32 1, 31, !dbg !1109
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1111
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1112

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1113
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1117
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1118
  %call = tail call i5 @codasip_immread_uint5(i32 2) #4, !dbg !1119
  %conv.i = and i32 1, 31, !dbg !1120
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1122
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1123

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1124
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1124
  br label %MI11rf_xpr_read.exit, !dbg !1125

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !1126
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1133
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1139
  %conv.i = and i32 1, 31, !dbg !1140
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1142
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1143

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1144
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1144
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1148
  %conv.i1 = and i32 1, 31, !dbg !1149
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1151
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1152

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1153
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1157
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1158
  %call = tail call i5 @codasip_immread_uint5(i32 2) #4, !dbg !1159
  %conv.i = and i32 1, 31, !dbg !1160
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1162
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1163

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1164
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1164
  br label %MI11rf_xpr_read.exit, !dbg !1165

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !1166
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1173
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1179
  %conv.i = and i32 1, 31, !dbg !1180
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1182
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1183

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1184
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1184
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1188
  %conv.i1 = and i32 1, 31, !dbg !1189
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1191
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1192

if.else.i6:                                       ; preds = %entry
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !1193
  %conv = sext i12 %call to i32, !dbg !1194
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1195
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1199
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1200
  %call = tail call i12 @codasip_immread_int12(i32 2) #4, !dbg !1201
  %conv.i = and i32 1, 31, !dbg !1202
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1204
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1205

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1206
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1206
  br label %MI11rf_xpr_read.exit, !dbg !1207

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !1208
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1215
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1221
  %conv.i = and i32 1, 31, !dbg !1222
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1224
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1225

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1226
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1226
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1230
  %conv.i1 = and i32 1, 31, !dbg !1231
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1233
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1234

if.else.i6:                                       ; preds = %entry
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !1235
  %conv = sext i12 %call to i32, !dbg !1236
  %cmp.i7 = icmp sgt i32 %conv, 0, !dbg !1237
  %storemerge11 = zext i1 %cmp.i7 to i32, !dbg !1239
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1240
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1244
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1245
  %call = tail call i12 @codasip_immread_int12(i32 2) #4, !dbg !1246
  %conv.i = and i32 1, 31, !dbg !1247
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1249
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1250

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1251
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1251
  br label %MI11rf_xpr_read.exit, !dbg !1252

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !1253
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1261
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1267
  %conv.i = and i32 1, 31, !dbg !1268
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1270
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1271

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1272
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1272
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1276
  %conv.i1 = and i32 1, 31, !dbg !1277
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1279
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1280

if.else.i6:                                       ; preds = %entry
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !1281
  %conv = sext i12 %call to i32, !dbg !1282
  %cmp3.i = icmp ne i32 %conv, 0, !dbg !1283
  %storemerge12 = zext i1 %cmp3.i to i32, !dbg !1285
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1286
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1290
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1291
  %call = tail call i12 @codasip_immread_int12(i32 2) #4, !dbg !1292
  %conv.i = and i32 1, 31, !dbg !1293
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1295
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1296

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1297
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1297
  br label %MI11rf_xpr_read.exit, !dbg !1298

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !1299
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1307
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1313
  %conv.i = and i32 1, 31, !dbg !1314
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1316
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1317

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1318
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1318
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1322
  %conv.i1 = and i32 1, 31, !dbg !1323
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1325
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1326

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1327
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1331
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1332
  %call = tail call i12 @codasip_immread_int12(i32 2) #4, !dbg !1333
  %conv.i = and i32 1, 31, !dbg !1334
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1336
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1337

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1338
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1338
  br label %MI11rf_xpr_read.exit, !dbg !1339

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !1340
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1347
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1353
  %conv.i = and i32 1, 31, !dbg !1354
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1356
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1357

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1358
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1358
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1362
  %conv.i1 = and i32 1, 31, !dbg !1363
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1365
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1366

if.else.i6:                                       ; preds = %entry
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !1367
  %conv = sext i12 %call to i32, !dbg !1368
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1369
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1373
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1374
  %call = tail call i12 @codasip_immread_int12(i32 2) #4, !dbg !1375
  %conv.i = and i32 1, 31, !dbg !1376
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1378
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1379

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1380
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1380
  br label %MI11rf_xpr_read.exit, !dbg !1381

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !1382
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1389
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1395
  %conv.i = and i32 1, 31, !dbg !1396
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1398
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1399

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1400
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1400
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1404
  %conv.i1 = and i32 1, 31, !dbg !1405
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1407
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1408

if.else.i6:                                       ; preds = %entry
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !1409
  %conv = sext i12 %call to i32, !dbg !1410
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1411
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1415
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1416
  %call = tail call i12 @codasip_immread_int12(i32 2) #4, !dbg !1417
  %conv.i = and i32 1, 31, !dbg !1418
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1420
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1421

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1422
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1422
  br label %MI11rf_xpr_read.exit, !dbg !1423

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !1424
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1431
...
if.end:
  %call = tail call i13 @codasip_immread_int13(i32 0) #4, !dbg !1435
  %shr = ashr i13 %call, 1, !dbg !1436
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1437
  %conv = sext i13 %shr to i32, !dbg !1438
  %shl = shl nsw i32 %conv, 1, !dbg !1439
  %add = add i32 %0, -4, !dbg !1440
  %sub4 = add i32 %add, %shl, !dbg !1441
  call void @llvm.br.anyint.i32(i32 %sub4, i1 true), !dbg !1442
  ret void, !dbg !1445
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1447
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !1448
  %shr = ashr i13 %call, 1, !dbg !1449
  %conv.i7 = and i32 1, 31, !dbg !1450
  %cmp.i8 = icmp eq i32 %conv.i7, 0, !dbg !1452
  br i1 %cmp.i8, label %if.then, label %if.else.i12, !dbg !1453

if.else.i12:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1454
  %2 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1454
  %phitmp = icmp eq i32 %2, 0, !dbg !1455
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1456

if.then:                                          ; preds = %entry, %if.else.i12
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1457
  %conv6 = sext i13 %shr to i32, !dbg !1458
  %shl = shl nsw i32 %conv6, 1, !dbg !1459
  %add = add nsw i32 %shl, -4, !dbg !1460
  %sub7 = add i32 %add, %3, !dbg !1461
  call void @llvm.br.anyint.i32(i32 %sub7, i1 true), !dbg !1462
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1467
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !1468
  %shr = ashr i13 %call, 1, !dbg !1469
  %conv.i = and i32 1, 31, !dbg !1470
...
MI11rf_xpr_read.exit:                             ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1474
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1474
  %cmp20.i = icmp eq i32 %2, 0, !dbg !1475
  br i1 %cmp20.i, label %if.then, label %if.end, !dbg !1477

if.then:                                          ; preds = %MI11rf_xpr_read.exit, %entry
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1478
  %conv6 = sext i13 %shr to i32, !dbg !1479
  %shl = shl nsw i32 %conv6, 1, !dbg !1480
  %add = add nsw i32 %shl, -4, !dbg !1481
  %sub7 = add i32 %add, %3, !dbg !1482
  call void @llvm.br.anyint.i32(i32 %sub7, i1 true), !dbg !1483
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1488
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1489
  %call = tail call i13 @codasip_immread_int13(i32 2) #4, !dbg !1490
  %shr = ashr i13 %call, 1, !dbg !1491
  %conv.i = and i32 2, 31, !dbg !1492
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1494
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1495

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1496
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1496
  br label %MI11rf_xpr_read.exit, !dbg !1497

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i7 = and i32 1, 31, !dbg !1498
...
if.else.i12:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1502
  %5 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1502
  br label %MI11rf_xpr_read.exit13, !dbg !1503

MI11rf_xpr_read.exit13:                           ; preds = %MI11rf_xpr_read.exit, %if.else.i12
  %storemerge14 = phi i32 [ %5, %if.else.i12 ], [ 0, %MI11rf_xpr_read.exit ]
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit13
  %6 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1507
  %conv8 = sext i13 %shr to i32, !dbg !1508
  %shl = shl nsw i32 %conv8, 1, !dbg !1509
  %add = add nsw i32 %shl, -4, !dbg !1510
  %sub9 = add i32 %add, %6, !dbg !1511
  call void @llvm.br.anyint.i32(i32 %sub9, i1 true), !dbg !1512
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1519
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !1520
  %shr = ashr i13 %call, 1, !dbg !1521
  %conv.i7 = and i32 1, 31, !dbg !1522
  %cmp.i8 = icmp eq i32 %conv.i7, 0, !dbg !1524
  br i1 %cmp.i8, label %if.end, label %if.else.i12, !dbg !1525

if.else.i12:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1526
  %2 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1526
  %phitmp = icmp eq i32 %2, 0, !dbg !1527
  br i1 %phitmp, label %if.end, label %if.then, !dbg !1528

if.then:                                          ; preds = %if.else.i12
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1529
  %conv6 = sext i13 %shr to i32, !dbg !1530
  %shl = shl nsw i32 %conv6, 1, !dbg !1531
  %add = add nsw i32 %shl, -4, !dbg !1532
  %sub7 = add i32 %add, %3, !dbg !1533
  call void @llvm.br.anyint.i32(i32 %sub7, i1 true), !dbg !1534
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1539
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !1540
  %shr = ashr i13 %call, 1, !dbg !1541
  %conv.i = and i32 1, 31, !dbg !1542
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1544
  br i1 %cmp.i, label %if.end, label %MI11rf_xpr_read.exit, !dbg !1545

MI11rf_xpr_read.exit:                             ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1546
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1546
  %cmp26.i = icmp eq i32 %2, 0, !dbg !1547
  br i1 %cmp26.i, label %if.end, label %if.then, !dbg !1550

if.then:                                          ; preds = %MI11rf_xpr_read.exit
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1551
  %conv6 = sext i13 %shr to i32, !dbg !1552
  %shl = shl nsw i32 %conv6, 1, !dbg !1553
  %add = add nsw i32 %shl, -4, !dbg !1554
  %sub7 = add i32 %add, %3, !dbg !1555
  call void @llvm.br.anyint.i32(i32 %sub7, i1 true), !dbg !1556
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1561
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1562
  %call = tail call i13 @codasip_immread_int13(i32 2) #4, !dbg !1563
  %shr = ashr i13 %call, 1, !dbg !1564
  %conv.i = and i32 2, 31, !dbg !1565
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1567
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1568

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1569
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1569
  br label %MI11rf_xpr_read.exit, !dbg !1570

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i7 = and i32 1, 31, !dbg !1571
  %cmp.i8 = icmp eq i32 %conv.i7, 0, !dbg !1573
  br i1 %cmp.i8, label %MI11rf_xpr_read.exit13, label %if.else.i12, !dbg !1574

if.else.i12:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1575
  %5 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1575
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit13
  %6 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1580
  %conv8 = sext i13 %shr to i32, !dbg !1581
  %shl = shl nsw i32 %conv8, 1, !dbg !1582
  %add = add nsw i32 %shl, -4, !dbg !1583
  %sub9 = add i32 %add, %6, !dbg !1584
  call void @llvm.br.anyint.i32(i32 %sub9, i1 true), !dbg !1585
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1592
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !1593
  %shr = ashr i13 %call, 1, !dbg !1594
  %conv.i7 = and i32 1, 31, !dbg !1595
  %cmp.i8 = icmp eq i32 %conv.i7, 0, !dbg !1597
  br i1 %cmp.i8, label %if.end, label %if.else.i12, !dbg !1598

if.else.i12:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1599
  %2 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1599
  %phitmp = icmp sgt i32 %2, 0, !dbg !1600
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1601

if.then:                                          ; preds = %if.else.i12
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1602
  %conv6 = sext i13 %shr to i32, !dbg !1603
  %shl = shl nsw i32 %conv6, 1, !dbg !1604
  %add = add nsw i32 %shl, -4, !dbg !1605
  %sub7 = add i32 %add, %3, !dbg !1606
  call void @llvm.br.anyint.i32(i32 %sub7, i1 true), !dbg !1607
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1612
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !1613
  %shr = ashr i13 %call, 1, !dbg !1614
  %conv.i = and i32 1, 31, !dbg !1615
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1617
  br i1 %cmp.i, label %if.end, label %MI11rf_xpr_read.exit, !dbg !1618

MI11rf_xpr_read.exit:                             ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1619
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1619
  %cmp = icmp sgt i32 %2, -1, !dbg !1620
  br i1 %cmp, label %if.end, label %if.then, !dbg !1621

if.then:                                          ; preds = %MI11rf_xpr_read.exit
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1622
  %conv6 = sext i13 %shr to i32, !dbg !1623
  %shl = shl nsw i32 %conv6, 1, !dbg !1624
  %add = add nsw i32 %shl, -4, !dbg !1625
  %sub7 = add i32 %add, %3, !dbg !1626
  call void @llvm.br.anyint.i32(i32 %sub7, i1 true), !dbg !1627
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1632
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1633
  %call = tail call i13 @codasip_immread_int13(i32 2) #4, !dbg !1634
  %shr = ashr i13 %call, 1, !dbg !1635
  %conv.i = and i32 2, 31, !dbg !1636
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1638
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1639

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1640
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1640
  br label %MI11rf_xpr_read.exit, !dbg !1641

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i7 = and i32 1, 31, !dbg !1642
  %cmp.i8 = icmp eq i32 %conv.i7, 0, !dbg !1644
  br i1 %cmp.i8, label %MI11rf_xpr_read.exit13, label %if.else.i12, !dbg !1645

if.else.i12:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1646
  %5 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1646
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit13
  %6 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1652
  %conv8 = sext i13 %shr to i32, !dbg !1653
  %shl = shl nsw i32 %conv8, 1, !dbg !1654
  %add = add nsw i32 %shl, -4, !dbg !1655
  %sub9 = add i32 %add, %6, !dbg !1656
  call void @llvm.br.anyint.i32(i32 %sub9, i1 true), !dbg !1657
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1664
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !1665
  %shr = ashr i13 %call, 1, !dbg !1666
  %conv.i7 = and i32 1, 31, !dbg !1667
  %cmp.i8 = icmp eq i32 %conv.i7, 0, !dbg !1669
  br i1 %cmp.i8, label %if.end, label %if.else.i12, !dbg !1670

if.else.i12:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1671
  %2 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1671
  %phitmp = icmp eq i32 %2, 0, !dbg !1672
  br i1 %phitmp, label %if.end, label %if.then, !dbg !1673

if.then:                                          ; preds = %if.else.i12
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1674
  %conv6 = sext i13 %shr to i32, !dbg !1675
  %shl = shl nsw i32 %conv6, 1, !dbg !1676
  %add = add nsw i32 %shl, -4, !dbg !1677
  %sub7 = add i32 %add, %3, !dbg !1678
  call void @llvm.br.anyint.i32(i32 %sub7, i1 true), !dbg !1679
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1684
  %conv.i = and i32 1, 31, !dbg !1685
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1687
  br i1 %cmp.i, label %if.end, label %if.else.i, !dbg !1688

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1689
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1689
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1693
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1694
  %call = tail call i13 @codasip_immread_int13(i32 2) #4, !dbg !1695
  %shr = ashr i13 %call, 1, !dbg !1696
  %conv.i = and i32 2, 31, !dbg !1697
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1699
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1700

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1701
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1701
  br label %MI11rf_xpr_read.exit, !dbg !1702

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i7 = and i32 1, 31, !dbg !1703
  %cmp.i8 = icmp eq i32 %conv.i7, 0, !dbg !1705
  br i1 %cmp.i8, label %MI11rf_xpr_read.exit13, label %if.else.i12, !dbg !1706

if.else.i12:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1707
  %5 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1707
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit13
  %6 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1712
  %conv8 = sext i13 %shr to i32, !dbg !1713
  %shl = shl nsw i32 %conv8, 1, !dbg !1714
  %add = add nsw i32 %shl, -4, !dbg !1715
  %sub9 = add i32 %add, %6, !dbg !1716
  call void @llvm.br.anyint.i32(i32 %sub9, i1 true), !dbg !1717
...
if.end:
  %call = tail call i13 @codasip_immread_int13(i32 0) #4, !dbg !1722
  %shr = ashr i13 %call, 1, !dbg !1723
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1724
  %conv = sext i13 %shr to i32, !dbg !1725
  %shl = shl nsw i32 %conv, 1, !dbg !1726
  %add = add i32 %0, -4, !dbg !1727
  %sub4 = add i32 %add, %shl, !dbg !1728
  call void @llvm.br.anyint.i32(i32 %sub4, i1 true), !dbg !1729
  ret void, !dbg !1731
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1733
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !1734
  %shr = ashr i13 %call, 1, !dbg !1735
  %conv.i7 = and i32 1, 31, !dbg !1736
  %cmp.i8 = icmp eq i32 %conv.i7, 0, !dbg !1738
  br i1 %cmp.i8, label %if.then, label %if.else.i12, !dbg !1739

if.else.i12:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1740
  %2 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1740
  %phitmp = icmp sgt i32 %2, 0, !dbg !1741
  br i1 %phitmp, label %if.end, label %if.then, !dbg !1742

if.then:                                          ; preds = %entry, %if.else.i12
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1743
  %conv6 = sext i13 %shr to i32, !dbg !1744
  %shl = shl nsw i32 %conv6, 1, !dbg !1745
  %add = add nsw i32 %shl, -4, !dbg !1746
  %sub7 = add i32 %add, %3, !dbg !1747
  call void @llvm.br.anyint.i32(i32 %sub7, i1 true), !dbg !1748
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1753
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !1754
  %shr = ashr i13 %call, 1, !dbg !1755
  %conv.i = and i32 1, 31, !dbg !1756
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1758
  br i1 %cmp.i, label %if.then, label %MI11rf_xpr_read.exit, !dbg !1759

MI11rf_xpr_read.exit:                             ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1760
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1760
  %cmp44.i = icmp slt i32 %2, 0, !dbg !1761
  br i1 %cmp44.i, label %if.end, label %if.then, !dbg !1763

if.then:                                          ; preds = %entry, %MI11rf_xpr_read.exit
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1764
  %conv6 = sext i13 %shr to i32, !dbg !1765
  %shl = shl nsw i32 %conv6, 1, !dbg !1766
  %add = add nsw i32 %shl, -4, !dbg !1767
  %sub7 = add i32 %add, %3, !dbg !1768
  call void @llvm.br.anyint.i32(i32 %sub7, i1 true), !dbg !1769
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1774
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1775
  %call = tail call i13 @codasip_immread_int13(i32 2) #4, !dbg !1776
  %shr = ashr i13 %call, 1, !dbg !1777
  %conv.i = and i32 2, 31, !dbg !1778
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1780
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1781

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1782
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1782
  br label %MI11rf_xpr_read.exit, !dbg !1783

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i7 = and i32 1, 31, !dbg !1784
  %cmp.i8 = icmp eq i32 %conv.i7, 0, !dbg !1786
  br i1 %cmp.i8, label %MI11rf_xpr_read.exit13, label %if.else.i12, !dbg !1787

if.else.i12:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1788
  %5 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1788
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit13
  %6 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1793
  %conv8 = sext i13 %shr to i32, !dbg !1794
  %shl = shl nsw i32 %conv8, 1, !dbg !1795
  %add = add nsw i32 %shl, -4, !dbg !1796
  %sub9 = add i32 %add, %6, !dbg !1797
  call void @llvm.br.anyint.i32(i32 %sub9, i1 true), !dbg !1798
...
if.end:
  %call = tail call i13 @codasip_immread_int13(i32 0) #4, !dbg !1803
  %shr = ashr i13 %call, 1, !dbg !1804
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1805
  %conv = sext i13 %shr to i32, !dbg !1806
  %shl = shl nsw i32 %conv, 1, !dbg !1807
  %add = add i32 %0, -4, !dbg !1808
  %sub4 = add i32 %add, %shl, !dbg !1809
  call void @llvm.br.anyint.i32(i32 %sub4, i1 true), !dbg !1810
  ret void, !dbg !1812
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1814
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !1815
  %shr = ashr i13 %call, 1, !dbg !1816
  %conv.i7 = and i32 1, 31, !dbg !1817
  %cmp.i8 = icmp eq i32 %conv.i7, 0, !dbg !1819
  br i1 %cmp.i8, label %if.then, label %if.else.i12, !dbg !1820

if.else.i12:                                      ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1821
  %2 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1821
  %phitmp = icmp eq i32 %2, 0, !dbg !1822
  br i1 %phitmp, label %if.then, label %if.end, !dbg !1823

if.then:                                          ; preds = %if.else.i12, %entry
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1824
  %conv6 = sext i13 %shr to i32, !dbg !1825
  %shl = shl nsw i32 %conv6, 1, !dbg !1826
  %add = add nsw i32 %shl, -4, !dbg !1827
  %sub7 = add i32 %add, %3, !dbg !1828
  call void @llvm.br.anyint.i32(i32 %sub7, i1 true), !dbg !1829
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1834
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !1835
  %shr = ashr i13 %call, 1, !dbg !1836
  %conv.i = and i32 1, 31, !dbg !1837
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1839
  br i1 %cmp.i, label %if.end, label %if.else.i, !dbg !1840

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1841
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1841
  br label %if.end, !dbg !1842

if.end:                                           ; preds = %entry, %if.else.i
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1843
  %conv6 = sext i13 %shr to i32, !dbg !1844
  %shl = shl nsw i32 %conv6, 1, !dbg !1845
  %add = add nsw i32 %shl, -4, !dbg !1846
  %sub7 = add i32 %add, %3, !dbg !1847
  call void @llvm.br.anyint.i32(i32 %sub7, i1 true), !dbg !1848
  ret void, !dbg !1850
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1852
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1853
  %call = tail call i13 @codasip_immread_int13(i32 2) #4, !dbg !1854
  %shr = ashr i13 %call, 1, !dbg !1855
  %conv.i = and i32 2, 31, !dbg !1856
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1858
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1859

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1860
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1860
  br label %MI11rf_xpr_read.exit, !dbg !1861

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i7 = and i32 1, 31, !dbg !1862
  %cmp.i8 = icmp eq i32 %conv.i7, 0, !dbg !1864
  br i1 %cmp.i8, label %MI11rf_xpr_read.exit13, label %if.else.i12, !dbg !1865

if.else.i12:                                      ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i11 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !1866
  %5 = load volatile i32, i32* %arrayidx.i11, align 4, !dbg !1866
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit13
  %6 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1871
  %conv8 = sext i13 %shr to i32, !dbg !1872
  %shl = shl nsw i32 %conv8, 1, !dbg !1873
  %add = add nsw i32 %shl, -4, !dbg !1874
  %sub9 = add i32 %add, %6, !dbg !1875
  call void @llvm.br.anyint.i32(i32 %sub9, i1 true), !dbg !1876
...
entry:
  %call = tail call i21 @codasip_immread_int21(i32 0) #4, !dbg !1881
  %shr = ashr i21 %call, 1, !dbg !1882
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1883
  %1 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1884
  %conv = sext i21 %shr to i32, !dbg !1885
  %shl = shl nsw i32 %conv, 1, !dbg !1886
  %add = add i32 %1, -4, !dbg !1887
  %sub1 = add i32 %add, %shl, !dbg !1888
  call void @llvm.br.anyint.i32(i32 %sub1, i1 true), !dbg !1889
  ret void, !dbg !1891
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1893
  %call = tail call i21 @codasip_immread_int21(i32 1) #4, !dbg !1894
  %shr = ashr i21 %call, 1, !dbg !1895
  %1 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1896
  %conv.i = and i32 1, 31, !dbg !1897
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1899
  br i1 %cmp.i, label %MI12rf_xpr_write.exit, label %if.else.i, !dbg !1900

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1901
  store volatile i32 %1, i32* %arrayidx.i, align 4, !dbg !1902
  br label %MI12rf_xpr_write.exit

MI12rf_xpr_write.exit:                            ; preds = %entry, %if.else.i
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1903
  %conv2 = sext i21 %shr to i32, !dbg !1904
  %shl = shl nsw i32 %conv2, 1, !dbg !1905
  %add = add i32 %3, -4, !dbg !1906
  %sub3 = add i32 %add, %shl, !dbg !1907
  call void @llvm.br.anyint.i32(i32 %sub3, i1 true), !dbg !1908
  ret void, !dbg !1910
}
...
entry:
  %call = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !1912
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1913
  %conv = sext i12 %call to i32, !dbg !1914
  call void @llvm.br.anyint.i32(i32 %conv, i1 true), !dbg !1915
  ret void, !dbg !1917
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !1919
  %call1 = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !1920
  %conv.i = and i32 1, 31, !dbg !1921
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1923
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1924

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1925
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1925
  br label %MI11rf_xpr_read.exit, !dbg !1926

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %2, %if.else.i ], [ 0, %entry ]
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1927
  %conv3 = sext i12 %call1 to i32, !dbg !1928
  %add = add i32 %storemerge, %conv3, !dbg !1929
  call void @llvm.br.anyint.i32(i32 %add, i1 true), !dbg !1930
  ret void, !dbg !1932
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1934
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !1935
  %1 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1936
  %conv.i1 = and i32 1, 31, !dbg !1937
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1939
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1940

if.else.i6:                                       ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1941
  store volatile i32 %1, i32* %arrayidx.i5, align 4, !dbg !1942
  br label %MI12rf_xpr_write.exit

MI12rf_xpr_write.exit:                            ; preds = %entry, %if.else.i6
  %conv3 = sext i12 %call to i32, !dbg !1943
  call void @llvm.br.anyint.i32(i32 %conv3, i1 true), !dbg !1944
  ret void, !dbg !1946
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !1948
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1949
  %call1 = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !1950
  %conv.i = and i32 1, 31, !dbg !1951
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !1953
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !1954

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1955
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !1955
  br label %MI11rf_xpr_read.exit, !dbg !1956

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %4 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1957
  %conv.i1 = and i32 2, 31, !dbg !1958
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1960
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !1961

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !1962
  store volatile i32 %4, i32* %arrayidx.i5, align 4, !dbg !1963
  br label %MI12rf_xpr_write.exit

MI12rf_xpr_write.exit:                            ; preds = %MI11rf_xpr_read.exit, %if.else.i6
  %conv5 = sext i12 %call1 to i32, !dbg !1964
  %add = add i32 %storemerge, %conv5, !dbg !1965
  call void @llvm.br.anyint.i32(i32 %add, i1 true), !dbg !1966
  ret void, !dbg !1968
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1972
  %conv.i1 = and i32 1, 31, !dbg !1973
...
if.else.i4:                                       ; preds = %entry
  %call = tail call i20 @codasip_immread_uint20(i32 1) #4, !dbg !1977
  %conv = zext i20 %call to i32, !dbg !1978
  %shl = shl nuw i32 %conv, 12, !dbg !1979
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !1980
...
entry:
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1984
  ret void, !dbg !1985
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !1987
  %1 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !1988
  %conv.i1 = and i32 1, 31, !dbg !1989
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !1991
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i4, !dbg !1992

if.else.i4:                                       ; preds = %entry
  %sub = add i32 %1, -4, !dbg !1993
  %call = tail call i20 @codasip_immread_uint20(i32 1) #4, !dbg !1994
  %conv = zext i20 %call to i32, !dbg !1995
  %shl = shl nuw i32 %conv, 12, !dbg !1996
  %add.i = add i32 %sub, %shl, !dbg !1997
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !1999
...
MI4load.exit:
  %call = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2003
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2004
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2013
  %call1 = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2014
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2015
  %conv.i = and i32 1, 31, !dbg !2016
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2018
  br i1 %cmp.i, label %MI4load.exit, label %if.else.i, !dbg !2019

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2020
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2020
...
MI4load.exit:                                     ; preds = %if.else.i, %entry
  ...
  %3 = load volatile i8, i8* %arrayidx.i.i, align 1, !dbg !2024
  ret void, !dbg !2027
}
...
MI4load.exit:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2029
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2030
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2031
  ...
  %1 = load volatile i8, i8* %arrayidx.i.i, align 1, !dbg !2033
  %conv.i1 = and i32 1, 31, !dbg !2036
...
if.else.i6:                                       ; preds = %MI4load.exit
  %conv4.i = sext i8 %1 to i32, !dbg !2040
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2041
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !2045
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2046
  %call1 = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2047
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2048
  %conv.i = and i32 1, 31, !dbg !2049
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2051
  br i1 %cmp.i, label %MI4load.exit, label %if.else.i, !dbg !2052

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2053
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2053
...
MI4load.exit:                                     ; preds = %entry, %if.else.i
  ...
  %4 = load volatile i8, i8* %arrayidx.i.i, align 1, !dbg !2057
  %conv.i1 = and i32 2, 31, !dbg !2060
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2062
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2063

if.else.i6:                                       ; preds = %MI4load.exit
  %conv4.i = sext i8 %4 to i32, !dbg !2064
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !2065
...
MI4load.exit:
  %call = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2069
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2070
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2077
  %call1 = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2078
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2079
  %conv.i = and i32 1, 31, !dbg !2080
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2082
  br i1 %cmp.i, label %MI4load.exit, label %if.else.i, !dbg !2083

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2084
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2084
...
MI4load.exit:                                     ; preds = %if.else.i, %entry
  ...
  %3 = load volatile i16, i16* %arrayidx4.i.i, align 2, !dbg !2088
  ret void, !dbg !2091
}
...
MI4load.exit:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2093
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2094
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2095
  ...
  %1 = load volatile i16, i16* %arrayidx4.i.i, align 2, !dbg !2097
  %conv.i1 = and i32 1, 31, !dbg !2100
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2102
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2103

if.else.i6:                                       ; preds = %MI4load.exit
  %conv7.i = sext i16 %1 to i32, !dbg !2104
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2105
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !2109
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2110
  %call1 = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2111
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2112
  %conv.i = and i32 1, 31, !dbg !2113
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2115
  br i1 %cmp.i, label %MI4load.exit, label %if.else.i, !dbg !2116

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2117
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2117
...
MI4load.exit:                                     ; preds = %entry, %if.else.i
  ...
  %4 = load volatile i16, i16* %arrayidx4.i.i, align 2, !dbg !2121
  %conv.i1 = and i32 2, 31, !dbg !2124
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2126
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2127

if.else.i6:                                       ; preds = %MI4load.exit
  %conv7.i = sext i16 %4 to i32, !dbg !2128
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !2129
...
MI4load.exit:
  %call = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2133
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2134
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2141
  %call1 = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2142
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2143
  %conv.i = and i32 1, 31, !dbg !2144
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2146
  br i1 %cmp.i, label %MI4load.exit, label %if.else.i, !dbg !2147

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2148
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2148
...
MI4load.exit:                                     ; preds = %if.else.i, %entry
  ...
  %3 = load volatile i32, i32* %arrayidx8.i.i, align 4, !dbg !2152
  ret void, !dbg !2155
}
...
MI4load.exit:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2157
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2158
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2159
  ...
  %1 = load volatile i32, i32* %arrayidx8.i.i, align 4, !dbg !2161
  %conv.i1 = and i32 1, 31, !dbg !2164
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2166
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2167

if.else.i6:                                       ; preds = %MI4load.exit
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2168
  store volatile i32 %1, i32* %arrayidx.i5, align 4, !dbg !2169
  br label %MI12rf_xpr_write.exit
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !2172
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2173
  %call1 = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2174
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2175
  %conv.i = and i32 1, 31, !dbg !2176
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2178
  br i1 %cmp.i, label %MI4load.exit, label %if.else.i, !dbg !2179

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2180
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2180
...
MI4load.exit:                                     ; preds = %entry, %if.else.i
  ...
  %4 = load volatile i32, i32* %arrayidx8.i.i, align 4, !dbg !2184
  %conv.i1 = and i32 2, 31, !dbg !2187
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2189
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2190

if.else.i6:                                       ; preds = %MI4load.exit
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !2191
  store volatile i32 %4, i32* %arrayidx.i5, align 4, !dbg !2192
  br label %MI12rf_xpr_write.exit
...
MI4load.exit:
  %call = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2195
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2196
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2203
  %call1 = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2204
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2205
  %conv.i = and i32 1, 31, !dbg !2206
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2208
  br i1 %cmp.i, label %MI4load.exit, label %if.else.i, !dbg !2209

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2210
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2210
...
MI4load.exit:                                     ; preds = %if.else.i, %entry
  ...
  %3 = load volatile i8, i8* %arrayidx.i.i, align 1, !dbg !2214
  ret void, !dbg !2217
}
...
MI4load.exit:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2219
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2220
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2221
  ...
  %1 = load volatile i8, i8* %arrayidx.i.i, align 1, !dbg !2223
  %conv.i1 = and i32 1, 31, !dbg !2226
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2228
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2229

if.else.i6:                                       ; preds = %MI4load.exit
  %conv.i.i = zext i8 %1 to i32, !dbg !2223
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2230
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !2234
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2235
  %call1 = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2236
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2237
  %conv.i = and i32 1, 31, !dbg !2238
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2240
  br i1 %cmp.i, label %MI4load.exit, label %if.else.i, !dbg !2241

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2242
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2242
...
MI4load.exit:                                     ; preds = %entry, %if.else.i
  ...
  %4 = load volatile i8, i8* %arrayidx.i.i, align 1, !dbg !2246
  %conv.i1 = and i32 2, 31, !dbg !2249
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2251
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2252

if.else.i6:                                       ; preds = %MI4load.exit
  %conv.i.i = zext i8 %4 to i32, !dbg !2246
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !2253
...
MI4load.exit:
  %call = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2257
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2258
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2265
  %call1 = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2266
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2267
  %conv.i = and i32 1, 31, !dbg !2268
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2270
  br i1 %cmp.i, label %MI4load.exit, label %if.else.i, !dbg !2271

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2272
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2272
...
MI4load.exit:                                     ; preds = %if.else.i, %entry
  ...
  %3 = load volatile i16, i16* %arrayidx4.i.i, align 2, !dbg !2276
  ret void, !dbg !2279
}
...
MI4load.exit:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2281
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2282
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2283
  ...
  %1 = load volatile i16, i16* %arrayidx4.i.i, align 2, !dbg !2285
  %conv.i1 = and i32 1, 31, !dbg !2288
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2290
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2291

if.else.i6:                                       ; preds = %MI4load.exit
  %conv5.i.i = zext i16 %1 to i32, !dbg !2285
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2292
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !2296
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2297
  %call1 = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2298
  tail call void @codasip_compiler_schedule_class(i32 0) #5, !dbg !2299
  %conv.i = and i32 1, 31, !dbg !2300
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2302
  br i1 %cmp.i, label %MI4load.exit, label %if.else.i, !dbg !2303

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2304
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2304
...
MI4load.exit:                                     ; preds = %entry, %if.else.i
  ...
  %4 = load volatile i16, i16* %arrayidx4.i.i, align 2, !dbg !2308
  %conv.i1 = and i32 2, 31, !dbg !2311
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2313
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2314

if.else.i6:                                       ; preds = %MI4load.exit
  %conv5.i.i = zext i16 %4 to i32, !dbg !2308
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !2315
...
entry:
  %call = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2319
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2329
  %call1 = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2330
  %conv.i = and i32 1, 31, !dbg !2331
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2333
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2334

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2335
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2335
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2345
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2346
  %conv = sext i12 %call to i32, !dbg !2347
  %conv.i3 = and i32 1, 31, !dbg !2348
...
if.else.i8:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2352
  %2 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !2352
  %phitmp = trunc i32 %2 to i8, !dbg !2353
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !2360
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2361
  %call1 = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2362
  %conv.i = and i32 1, 31, !dbg !2363
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2365
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2366

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2367
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2367
...
if.else.i8:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !2375
  %5 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !2375
  %phitmp = trunc i32 %5 to i8, !dbg !2376
...
entry:
  %call = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2383
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2391
  %call1 = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2392
  %conv.i = and i32 1, 31, !dbg !2393
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2395
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2396

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2397
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2397
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2407
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2408
  %conv = sext i12 %call to i32, !dbg !2409
  %conv.i3 = and i32 1, 31, !dbg !2410
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !2412
  br i1 %cmp.i4, label %MI11rf_xpr_read.exit9, label %if.else.i8, !dbg !2413

if.else.i8:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2414
  %2 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !2414
  %phitmp = trunc i32 %2 to i16, !dbg !2415
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !2422
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2423
  %call1 = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2424
  %conv.i = and i32 1, 31, !dbg !2425
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2427
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2428

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2429
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2429
...
MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  ...
  %conv.i3 = and i32 2, 31, !dbg !2433
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !2435
  br i1 %cmp.i4, label %MI11rf_xpr_read.exit9, label %if.else.i8, !dbg !2436

if.else.i8:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !2437
  %5 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !2437
  %phitmp = trunc i32 %5 to i16, !dbg !2438
...
entry:
  %call = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2445
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2453
  %call1 = tail call i12 @codasip_immread_int12(i32 0) #4, !dbg !2454
  %conv.i = and i32 1, 31, !dbg !2455
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2457
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2458

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2459
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2459
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2469
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2470
  %conv = sext i12 %call to i32, !dbg !2471
  %conv.i3 = and i32 1, 31, !dbg !2472
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !2474
  br i1 %cmp.i4, label %MI11rf_xpr_read.exit9, label %if.else.i8, !dbg !2475

if.else.i8:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2476
  %2 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !2476
  br label %MI11rf_xpr_read.exit9, !dbg !2477

MI11rf_xpr_read.exit9:                            ; preds = %entry, %if.else.i8
  %storemerge10 = phi i32 [ %2, %if.else.i8 ], [ 0, %entry ]
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 2) #4, !dbg !2484
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2485
  %call1 = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2486
  %conv.i = and i32 1, 31, !dbg !2487
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2489
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2490

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 2, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2491
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2491
...
MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  ...
  %conv.i3 = and i32 2, 31, !dbg !2495
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !2497
  br i1 %cmp.i4, label %MI11rf_xpr_read.exit9, label %if.else.i8, !dbg !2498

if.else.i8:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !2499
  %5 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !2499
  br label %MI11rf_xpr_read.exit9, !dbg !2500

MI11rf_xpr_read.exit9:                            ; preds = %MI11rf_xpr_read.exit, %if.else.i8
  %storemerge10 = phi i32 [ %5, %if.else.i8 ], [ 0, %MI11rf_xpr_read.exit ]
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2509
  %conv.i = and i32 1, 31, !dbg !2510
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2512
  br i1 %cmp.i, label %MI12rf_xpr_write.exit, label %if.else.i, !dbg !2513

if.else.i:                                        ; preds = %entry
  %call = tail call i12 @codasip_immread_int12(i32 1) #4, !dbg !2514
  %conv = sext i12 %call to i32, !dbg !2515
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2516
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2522
  %conv.i = and i32 1, 31, !dbg !2523
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2525
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2526

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2527
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2527
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2531
  %conv.i1 = and i32 1, 31, !dbg !2532
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2534
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2535

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2536
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2540
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2541
  %conv.i = and i32 1, 31, !dbg !2542
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2544
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2545

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2546
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2546
  br label %MI11rf_xpr_read.exit, !dbg !2547

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !2548
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2550
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2551

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !2552
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2558
  %conv.i = and i32 1, 31, !dbg !2559
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2561
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2562

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2563
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2563
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2567
  %conv.i1 = and i32 1, 31, !dbg !2568
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2570
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2571

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2572
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2576
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2577
  %conv.i = and i32 1, 31, !dbg !2578
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2580
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2581

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2582
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2582
  %phitmp = xor i32 %3, -1, !dbg !2583
  br label %MI11rf_xpr_read.exit, !dbg !2583

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %phitmp, %if.else.i ], [ -1, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !2584
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2586
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2587

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !2588
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2594
  %conv.i = and i32 1, 31, !dbg !2595
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2597
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2598

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2599
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2599
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2603
  %conv.i1 = and i32 1, 31, !dbg !2604
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2606
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2607

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2608
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2612
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2613
  %conv.i = and i32 1, 31, !dbg !2614
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2616
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2617

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2618
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2618
  br label %MI11rf_xpr_read.exit, !dbg !2619

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i1 = and i32 2, 31, !dbg !2620
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit
  ...
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !2625
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2631
  %conv.i = and i32 1, 31, !dbg !2632
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2634
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2635

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2636
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2636
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2640
  %conv.i1 = and i32 1, 31, !dbg !2641
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2644
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2645

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2646
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2650
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2651
  %conv.i = and i32 1, 31, !dbg !2652
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2654
  br i1 %cmp.i, label %MI11rf_xpr_read.exit.thread, label %MI11rf_xpr_read.exit, !dbg !2655

MI11rf_xpr_read.exit:                             ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2656
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2656
  %phitmp = icmp eq i32 %3, 0, !dbg !2657
  br i1 %phitmp, label %MI11rf_xpr_read.exit.thread, label %4, !dbg !2658

MI11rf_xpr_read.exit.thread:                      ; preds = %entry, %MI11rf_xpr_read.exit
  br label %4, !dbg !2658

; <label>:4:                                      ; preds = %MI11rf_xpr_read.exit, %MI11rf_xpr_read.exit.thread
  %5 = phi i32 [ 1, %MI11rf_xpr_read.exit.thread ], [ 0, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 2, 31, !dbg !2659
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2662
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2663

if.else.i6:                                       ; preds = %4
  %6 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %6, !dbg !2664
  store volatile i32 %5, i32* %arrayidx.i5, align 4, !dbg !2665
  br label %MI12rf_xpr_write.exit

MI12rf_xpr_write.exit:                            ; preds = %4, %if.else.i6
  ret void, !dbg !2666
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2670
  %conv.i = and i32 1, 31, !dbg !2671
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2673
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2674

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2675
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2675
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2679
  %conv.i1 = and i32 1, 31, !dbg !2680
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2683
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2684

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2685
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2689
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2690
  %conv.i = and i32 1, 31, !dbg !2691
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2693
  br i1 %cmp.i, label %MI11rf_xpr_read.exit.thread, label %MI11rf_xpr_read.exit, !dbg !2694

MI11rf_xpr_read.exit:                             ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2695
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2695
  %phitmp = icmp ne i32 %3, 0, !dbg !2696
...
MI11rf_xpr_read.exit.thread:                      ; preds = %MI11rf_xpr_read.exit, %entry
  %4 = phi i32 [ 0, %entry ], [ %., %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 2, 31, !dbg !2698
...
if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit.thread
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !2703
  store volatile i32 %4, i32* %arrayidx.i5, align 4, !dbg !2704
  br label %MI12rf_xpr_write.exit
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2709
  %conv.i = and i32 1, 31, !dbg !2710
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2712
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2713

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2714
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2714
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2718
  %conv.i1 = and i32 1, 31, !dbg !2719
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2722
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2723

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2724
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2728
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2729
  %conv.i = and i32 1, 31, !dbg !2730
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2732
  br i1 %cmp.i, label %MI11rf_xpr_read.exit.thread, label %MI11rf_xpr_read.exit, !dbg !2733

MI11rf_xpr_read.exit:                             ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2734
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2734
  %.lobit = lshr i32 %3, 31, !dbg !2735
  br label %MI11rf_xpr_read.exit.thread, !dbg !2735

MI11rf_xpr_read.exit.thread:                      ; preds = %MI11rf_xpr_read.exit, %entry
  %4 = phi i32 [ 0, %entry ], [ %.lobit, %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 2, 31, !dbg !2736
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2739
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2740

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit.thread
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !2741
  store volatile i32 %4, i32* %arrayidx.i5, align 4, !dbg !2742
  br label %MI12rf_xpr_write.exit
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2747
  %conv.i = and i32 1, 31, !dbg !2748
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2750
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2751

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2752
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2752
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2756
  %conv.i1 = and i32 1, 31, !dbg !2757
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2760
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2761

if.else.i6:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2762
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2766
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2767
  %conv.i = and i32 1, 31, !dbg !2768
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2770
  br i1 %cmp.i, label %MI11rf_xpr_read.exit.thread, label %MI11rf_xpr_read.exit, !dbg !2771

MI11rf_xpr_read.exit:                             ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2772
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2772
  %phitmp = icmp sgt i32 %3, 0, !dbg !2773
  %. = zext i1 %phitmp to i32, !dbg !2774
  br label %MI11rf_xpr_read.exit.thread, !dbg !2774

MI11rf_xpr_read.exit.thread:                      ; preds = %MI11rf_xpr_read.exit, %entry
  %4 = phi i32 [ 0, %entry ], [ %., %MI11rf_xpr_read.exit ]
  %conv.i1 = and i32 2, 31, !dbg !2775
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !2778
  br i1 %cmp.i2, label %MI12rf_xpr_write.exit, label %if.else.i6, !dbg !2779

if.else.i6:                                       ; preds = %MI11rf_xpr_read.exit.thread
  %5 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %5, !dbg !2780
  store volatile i32 %4, i32* %arrayidx.i5, align 4, !dbg !2781
  br label %MI12rf_xpr_write.exit
...
entry:
  %call = tail call i13 @codasip_immread_int13(i32 0) #4, !dbg !2784
  %shr = ashr i13 %call, 1, !dbg !2785
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !2786
  %conv = sext i13 %shr to i32, !dbg !2787
  %shl = shl nsw i32 %conv, 1, !dbg !2788
  %add = add i32 %0, -4, !dbg !2789
  %sub2 = add i32 %add, %shl, !dbg !2790
  call void @llvm.br.anyint.i32(i32 %sub2, i1 true), !dbg !2791
  ret void, !dbg !2793
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2795
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !2796
  %shr = ashr i13 %call, 1, !dbg !2797
  %conv.i = and i32 1, 31, !dbg !2798
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2800
  br i1 %cmp.i, label %if.then, label %if.else.i, !dbg !2801

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2802
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2802
  %phitmp = icmp eq i32 %2, 0, !dbg !2803
  br i1 %phitmp, label %if.then, label %if.end, !dbg !2804

if.then:                                          ; preds = %entry, %if.else.i
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !2805
  %conv4 = sext i13 %shr to i32, !dbg !2806
  %shl = shl nsw i32 %conv4, 1, !dbg !2807
  %add = add nsw i32 %shl, -4, !dbg !2808
  %sub5 = add i32 %add, %3, !dbg !2809
  call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !2810
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2817
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !2818
  %shr = ashr i13 %call, 1, !dbg !2819
  %conv.i = and i32 1, 31, !dbg !2820
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2822
  br i1 %cmp.i, label %if.end, label %if.else.i, !dbg !2823

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2824
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2824
  %phitmp = icmp eq i32 %2, 0, !dbg !2825
  br i1 %phitmp, label %if.end, label %if.then, !dbg !2826

if.then:                                          ; preds = %if.else.i
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !2827
  %conv4 = sext i13 %shr to i32, !dbg !2828
  %shl = shl nsw i32 %conv4, 1, !dbg !2829
  %add = add nsw i32 %shl, -4, !dbg !2830
  %sub5 = add i32 %add, %3, !dbg !2831
  call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !2832
...
entry:
  %call = tail call i13 @codasip_immread_int13(i32 0) #4, !dbg !2837
  %shr = ashr i13 %call, 1, !dbg !2838
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !2839
  %conv = sext i13 %shr to i32, !dbg !2840
  %shl = shl nsw i32 %conv, 1, !dbg !2841
  %add = add i32 %0, -4, !dbg !2842
  %sub2 = add i32 %add, %shl, !dbg !2843
  call void @llvm.br.anyint.i32(i32 %sub2, i1 true), !dbg !2844
  ret void, !dbg !2846
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2848
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !2849
  %shr = ashr i13 %call, 1, !dbg !2850
  %conv.i = and i32 1, 31, !dbg !2851
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2853
  br i1 %cmp.i, label %if.then, label %if.else.i, !dbg !2854

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2855
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2855
  %phitmp = icmp slt i32 %2, 1, !dbg !2856
  br i1 %phitmp, label %if.then, label %if.end, !dbg !2857

if.then:                                          ; preds = %entry, %if.else.i
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !2858
  %conv4 = sext i13 %shr to i32, !dbg !2859
  %shl = shl nsw i32 %conv4, 1, !dbg !2860
  %add = add nsw i32 %shl, -4, !dbg !2861
  %sub5 = add i32 %add, %3, !dbg !2862
  call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !2863
...
entry:
  %call = tail call i13 @codasip_immread_int13(i32 0) #4, !dbg !2868
  %shr = ashr i13 %call, 1, !dbg !2869
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !2870
  %conv = sext i13 %shr to i32, !dbg !2871
  %shl = shl nsw i32 %conv, 1, !dbg !2872
  %add = add i32 %0, -4, !dbg !2873
  %sub2 = add i32 %add, %shl, !dbg !2874
  call void @llvm.br.anyint.i32(i32 %sub2, i1 true), !dbg !2875
  ret void, !dbg !2877
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2879
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !2880
  %shr = ashr i13 %call, 1, !dbg !2881
  %conv.i = and i32 1, 31, !dbg !2882
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2884
  br i1 %cmp.i, label %if.then, label %if.else.i, !dbg !2885

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2886
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2886
  %phitmp = icmp sgt i32 %2, -1, !dbg !2887
  br i1 %phitmp, label %if.then, label %if.end, !dbg !2888

if.then:                                          ; preds = %entry, %if.else.i
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !2889
  %conv4 = sext i13 %shr to i32, !dbg !2890
  %shl = shl nsw i32 %conv4, 1, !dbg !2891
  %add = add nsw i32 %shl, -4, !dbg !2892
  %sub5 = add i32 %add, %3, !dbg !2893
  call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !2894
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2901
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !2902
  %shr = ashr i13 %call, 1, !dbg !2903
  %conv.i = and i32 1, 31, !dbg !2904
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2906
  br i1 %cmp.i, label %if.end, label %if.else.i, !dbg !2907

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2908
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2908
  %phitmp = icmp slt i32 %2, 0, !dbg !2909
  br i1 %phitmp, label %if.then, label %if.end, !dbg !2910

if.then:                                          ; preds = %if.else.i
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !2911
  %conv4 = sext i13 %shr to i32, !dbg !2912
  %shl = shl nsw i32 %conv4, 1, !dbg !2913
  %add = add nsw i32 %shl, -4, !dbg !2914
  %sub5 = add i32 %add, %3, !dbg !2915
  call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !2916
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2923
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !2924
  %shr = ashr i13 %call, 1, !dbg !2925
  %conv.i = and i32 1, 31, !dbg !2926
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2928
  br i1 %cmp.i, label %if.end, label %if.else.i, !dbg !2929

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2930
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2930
  %phitmp = icmp sgt i32 %2, 0, !dbg !2931
  br i1 %phitmp, label %if.then, label %if.end, !dbg !2932

if.then:                                          ; preds = %if.else.i
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !2933
  %conv4 = sext i13 %shr to i32, !dbg !2934
  %shl = shl nsw i32 %conv4, 1, !dbg !2935
  %add = add nsw i32 %shl, -4, !dbg !2936
  %sub5 = add i32 %add, %3, !dbg !2937
  call void @llvm.br.anyint.i32(i32 %sub5, i1 true), !dbg !2938
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2945
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !2946
  %shr = ashr i13 %call, 1, !dbg !2947
  %conv.i3 = and i32 1, 31, !dbg !2948
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !2950
  br i1 %cmp.i4, label %if.end, label %if.else.i8, !dbg !2951

if.else.i8:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2952
  %2 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !2952
  %phitmp = icmp slt i32 %2, 0, !dbg !2953
  br i1 %phitmp, label %if.then, label %if.end, !dbg !2954

if.then:                                          ; preds = %if.else.i8
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !2955
  %conv5 = sext i13 %shr to i32, !dbg !2956
  %shl = shl nsw i32 %conv5, 1, !dbg !2957
  %add = add nsw i32 %shl, -4, !dbg !2958
  %sub6 = add i32 %add, %3, !dbg !2959
  call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !2960
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2965
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !2966
  %shr = ashr i13 %call, 1, !dbg !2967
  %conv.i = and i32 1, 31, !dbg !2968
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2970
  br i1 %cmp.i, label %if.end, label %MI11rf_xpr_read.exit, !dbg !2971

MI11rf_xpr_read.exit:                             ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !2972
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2972
  %cmp = icmp sgt i32 %2, 0, !dbg !2973
  br i1 %cmp, label %if.then, label %if.end, !dbg !2974

if.then:                                          ; preds = %MI11rf_xpr_read.exit
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !2975
  %conv5 = sext i13 %shr to i32, !dbg !2976
  %shl = shl nsw i32 %conv5, 1, !dbg !2977
  %add = add nsw i32 %shl, -4, !dbg !2978
  %sub6 = add i32 %add, %3, !dbg !2979
  call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !2980
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !2985
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !2986
  %call = tail call i13 @codasip_immread_int13(i32 2) #4, !dbg !2987
  %shr = ashr i13 %call, 1, !dbg !2988
  %conv.i = and i32 2, 31, !dbg !2989
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !2991
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !2992

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !2993
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !2993
  br label %MI11rf_xpr_read.exit, !dbg !2994

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i3 = and i32 1, 31, !dbg !2995
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !2997
  br i1 %cmp.i4, label %MI11rf_xpr_read.exit9, label %if.else.i8, !dbg !2998

if.else.i8:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !2999
  %5 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !2999
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit9
  %6 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3003
  %conv7 = sext i13 %shr to i32, !dbg !3004
  %shl = shl nsw i32 %conv7, 1, !dbg !3005
  %add = add nsw i32 %shl, -4, !dbg !3006
  %sub8 = add i32 %add, %6, !dbg !3007
  call void @llvm.br.anyint.i32(i32 %sub8, i1 true), !dbg !3008
...
if.end:
  %call = tail call i13 @codasip_immread_int13(i32 0) #4, !dbg !3013
  %shr = ashr i13 %call, 1, !dbg !3014
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3015
  %conv = sext i13 %shr to i32, !dbg !3016
  %shl = shl nsw i32 %conv, 1, !dbg !3017
  %add = add i32 %0, -4, !dbg !3018
  %sub3 = add i32 %add, %shl, !dbg !3019
  call void @llvm.br.anyint.i32(i32 %sub3, i1 true), !dbg !3020
  ret void, !dbg !3022
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3024
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !3025
  %shr = ashr i13 %call, 1, !dbg !3026
  %conv.i3 = and i32 1, 31, !dbg !3027
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !3029
  br i1 %cmp.i4, label %if.then, label %if.else.i8, !dbg !3030

if.else.i8:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !3031
  %2 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !3031
  %phitmp = icmp slt i32 %2, 0, !dbg !3032
  br i1 %phitmp, label %if.end, label %if.then, !dbg !3033

if.then:                                          ; preds = %entry, %if.else.i8
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3034
  %conv5 = sext i13 %shr to i32, !dbg !3035
  %shl = shl nsw i32 %conv5, 1, !dbg !3036
  %add = add nsw i32 %shl, -4, !dbg !3037
  %sub6 = add i32 %add, %3, !dbg !3038
  call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !3039
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3044
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !3045
  %shr = ashr i13 %call, 1, !dbg !3046
  %conv.i = and i32 1, 31, !dbg !3047
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !3049
  br i1 %cmp.i, label %if.then, label %MI11rf_xpr_read.exit, !dbg !3050

MI11rf_xpr_read.exit:                             ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !3051
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !3051
  %cmp = icmp sgt i32 %2, 0, !dbg !3052
  br i1 %cmp, label %if.end, label %if.then, !dbg !3053

if.then:                                          ; preds = %entry, %MI11rf_xpr_read.exit
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3054
  %conv5 = sext i13 %shr to i32, !dbg !3055
  %shl = shl nsw i32 %conv5, 1, !dbg !3056
  %add = add nsw i32 %shl, -4, !dbg !3057
  %sub6 = add i32 %add, %3, !dbg !3058
  call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !3059
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !3064
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3065
  %call = tail call i13 @codasip_immread_int13(i32 2) #4, !dbg !3066
  %shr = ashr i13 %call, 1, !dbg !3067
  %conv.i = and i32 2, 31, !dbg !3068
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !3070
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !3071

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !3072
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !3072
  br label %MI11rf_xpr_read.exit, !dbg !3073

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i3 = and i32 1, 31, !dbg !3074
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !3076
  br i1 %cmp.i4, label %MI11rf_xpr_read.exit9, label %if.else.i8, !dbg !3077

if.else.i8:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !3078
  %5 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !3078
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit9
  %6 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3082
  %conv7 = sext i13 %shr to i32, !dbg !3083
  %shl = shl nsw i32 %conv7, 1, !dbg !3084
  %add = add nsw i32 %shl, -4, !dbg !3085
  %sub8 = add i32 %add, %6, !dbg !3086
  call void @llvm.br.anyint.i32(i32 %sub8, i1 true), !dbg !3087
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3094
  %conv.i3 = and i32 1, 31, !dbg !3095
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !3097
  br i1 %cmp.i4, label %if.end, label %if.else.i8, !dbg !3098

if.else.i8:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !3099
  %2 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !3099
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3103
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !3104
  %shr = ashr i13 %call, 1, !dbg !3105
  %conv.i = and i32 1, 31, !dbg !3106
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !3108
  br i1 %cmp.i, label %if.end, label %MI11rf_xpr_read.exit, !dbg !3109

MI11rf_xpr_read.exit:                             ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !3110
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !3110
  %cmp = icmp eq i32 %2, 0, !dbg !3111
  br i1 %cmp, label %if.end, label %if.then, !dbg !3112

if.then:                                          ; preds = %MI11rf_xpr_read.exit
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3113
  %conv5 = sext i13 %shr to i32, !dbg !3114
  %shl = shl nsw i32 %conv5, 1, !dbg !3115
  %add = add nsw i32 %shl, -4, !dbg !3116
  %sub6 = add i32 %add, %3, !dbg !3117
  call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !3118
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !3123
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3124
  %call = tail call i13 @codasip_immread_int13(i32 2) #4, !dbg !3125
  %shr = ashr i13 %call, 1, !dbg !3126
  %conv.i = and i32 2, 31, !dbg !3127
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !3129
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !3130

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !3131
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !3131
  br label %MI11rf_xpr_read.exit, !dbg !3132

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i3 = and i32 1, 31, !dbg !3133
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !3135
  br i1 %cmp.i4, label %MI11rf_xpr_read.exit9, label %if.else.i8, !dbg !3136

if.else.i8:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !3137
  %5 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !3137
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit9
  %6 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3141
  %conv7 = sext i13 %shr to i32, !dbg !3142
  %shl = shl nsw i32 %conv7, 1, !dbg !3143
  %add = add nsw i32 %shl, -4, !dbg !3144
  %sub8 = add i32 %add, %6, !dbg !3145
  call void @llvm.br.anyint.i32(i32 %sub8, i1 true), !dbg !3146
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3153
  %call = tail call i13 @codasip_immread_int13(i32 1) #4, !dbg !3154
  %shr = ashr i13 %call, 1, !dbg !3155
  %conv.i3 = and i32 1, 31, !dbg !3156
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !3158
  br i1 %cmp.i4, label %if.end, label %if.else.i8, !dbg !3159

if.else.i8:                                       ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !3160
  %2 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !3160
  %phitmp = icmp eq i32 %2, 0, !dbg !3161
  br i1 %phitmp, label %if.end, label %if.then, !dbg !3162

if.then:                                          ; preds = %if.else.i8
  %3 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3163
  %conv5 = sext i13 %shr to i32, !dbg !3164
  %shl = shl nsw i32 %conv5, 1, !dbg !3165
  %add = add nsw i32 %shl, -4, !dbg !3166
  %sub6 = add i32 %add, %3, !dbg !3167
  call void @llvm.br.anyint.i32(i32 %sub6, i1 true), !dbg !3168
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3173
  %conv.i = and i32 1, 31, !dbg !3174
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !3176
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !3177

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !3178
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !3178
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 1) #4, !dbg !3182
  %1 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3183
  %call = tail call i13 @codasip_immread_int13(i32 2) #4, !dbg !3184
  %shr = ashr i13 %call, 1, !dbg !3185
  %conv.i = and i32 2, 31, !dbg !3186
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !3188
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !3189

if.else.i:                                        ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !3190
  %3 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !3190
  br label %MI11rf_xpr_read.exit, !dbg !3191

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %3, %if.else.i ], [ 0, %entry ]
  %conv.i3 = and i32 1, 31, !dbg !3192
  %cmp.i4 = icmp eq i32 %conv.i3, 0, !dbg !3194
  br i1 %cmp.i4, label %MI11rf_xpr_read.exit9, label %if.else.i8, !dbg !3195

if.else.i8:                                       ; preds = %MI11rf_xpr_read.exit
  %4 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 1, i32 0)
  %arrayidx.i7 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %4, !dbg !3196
  %5 = load volatile i32, i32* %arrayidx.i7, align 4, !dbg !3196
...
if.then:                                          ; preds = %MI11rf_xpr_read.exit9
  %6 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3200
  %conv7 = sext i13 %shr to i32, !dbg !3201
  %shl = shl nsw i32 %conv7, 1, !dbg !3202
  %add = add nsw i32 %shl, -4, !dbg !3203
  %sub8 = add i32 %add, %6, !dbg !3204
  call void @llvm.br.anyint.i32(i32 %sub8, i1 true), !dbg !3205
...
entry:
  %call = tail call i21 @codasip_immread_int21(i32 0) #4, !dbg !3210
  %shr = ashr i21 %call, 1, !dbg !3211
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3212
  %conv = sext i21 %shr to i32, !dbg !3213
  %shl = shl nsw i32 %conv, 1, !dbg !3214
  %add = add i32 %0, -4, !dbg !3215
  %sub1 = add i32 %add, %shl, !dbg !3216
  call void @llvm.br.anyint.i32(i32 %sub1, i1 true), !dbg !3217
  ret void, !dbg !3219
}
...
entry:
  call void @llvm.br.anyint.i32(i32 0, i1 true), !dbg !3221
  ret void, !dbg !3223
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3225
  %conv.i = and i32 1, 31, !dbg !3226
  %cmp.i = icmp eq i32 %conv.i, 0, !dbg !3228
  br i1 %cmp.i, label %MI11rf_xpr_read.exit, label %if.else.i, !dbg !3229

if.else.i:                                        ; preds = %entry
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !3230
  %2 = load volatile i32, i32* %arrayidx.i, align 4, !dbg !3230
  br label %MI11rf_xpr_read.exit, !dbg !3231

MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i
  %storemerge = phi i32 [ %2, %if.else.i ], [ 0, %entry ]
  call void @llvm.br.anyint.i32(i32 %storemerge, i1 true), !dbg !3232
  ret void, !dbg !3234
}
...
entry:
  %0 = call i32 @llvm.regread.anyint.i32(i32 35, i32 1), !dbg !3236
  call void @llvm.br.anyint.i32(i32 %0, i1 true), !dbg !3238
  ret void, !dbg !3240
}
...
entry:
  %call = tail call i21 @codasip_immread_int21(i32 0) #4, !dbg !3242
  %shr = ashr i21 %call, 1, !dbg !3243
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3244
  call void @llvm.regwrite.anyint.i32(i32 35, i32 1, i32 %0, i1 true), !dbg !3245
  %1 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3247
  %conv = sext i21 %shr to i32, !dbg !3248
  %shl = shl nsw i32 %conv, 1, !dbg !3249
  %add = add i32 %1, -4, !dbg !3250
  %sub1 = add i32 %add, %shl, !dbg !3251
  call void @llvm.br.anyint.i32(i32 %sub1, i1 true), !dbg !3252
  ret void, !dbg !3254
}
...
entry:
  %0 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3256
  call void @llvm.regwrite.anyint.i32(i32 35, i32 1, i32 %0, i1 true), !dbg !3257
  call void @llvm.br.anyint.i32(i32 0, i1 true), !dbg !3259
  ret void, !dbg !3261
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3263
  %1 = call i32 @llvm.getnextpc.anyint.i32(), !dbg !3264
  call void @llvm.regwrite.anyint.i32(i32 35, i32 1, i32 %1, i1 true), !dbg !3265
  %conv.i1 = and i32 1, 31, !dbg !3267
  %cmp.i2 = icmp eq i32 %conv.i1, 0, !dbg !3269
  br i1 %cmp.i2, label %MI11rf_xpr_read.exit, label %if.else.i6, !dbg !3270

if.else.i6:                                       ; preds = %entry
  %2 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx.i5 = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %2, !dbg !3271
  %3 = load volatile i32, i32* %arrayidx.i5, align 4, !dbg !3271
  %phitmp = and i32 %3, -4, !dbg !3272
...
MI11rf_xpr_read.exit:                             ; preds = %entry, %if.else.i6
  ...
  call void @llvm.br.anyint.i32(i32 %storemerge, i1 true), !dbg !3273
  ret void, !dbg !3275
}
...
entry:
  %0 = tail call i32 @codasip_regopindex(i32 0, i32 0) #4, !dbg !3277
  %call = tail call i32 @codasip_immread_uint32(i32 1) #4, !dbg !3278
  %1 = call i32 @llvm.propagatedregopindex.i32(i32 0, i32 0, i32 0)
  %arrayidx = getelementptr inbounds [32 x i32], [32 x i32]* @rf_xpr, i32 0, i32 %1, !dbg !3279
...
!1077 = !DILocation(line: 213, column: 75, scope: !1076)
!1078 = !DILocation(line: 214, column: 74, scope: !1076)
!1079 = !DILocation(line: 211, column: 57, scope: !1076)
...
!1117 = !DILocation(line: 213, column: 75, scope: !1116)
!1118 = !DILocation(line: 214, column: 74, scope: !1116)
!1119 = !DILocation(line: 211, column: 57, scope: !1116)
...
!1157 = !DILocation(line: 213, column: 75, scope: !1156)
!1158 = !DILocation(line: 214, column: 74, scope: !1156)
!1159 = !DILocation(line: 211, column: 57, scope: !1156)
...
!1199 = !DILocation(line: 248, column: 75, scope: !1198)
!1200 = !DILocation(line: 249, column: 74, scope: !1198)
!1201 = !DILocation(line: 246, column: 58, scope: !1198)
...
!1244 = !DILocation(line: 248, column: 75, scope: !1243)
!1245 = !DILocation(line: 249, column: 74, scope: !1243)
!1246 = !DILocation(line: 246, column: 58, scope: !1243)
...
!1290 = !DILocation(line: 248, column: 75, scope: !1289)
!1291 = !DILocation(line: 249, column: 74, scope: !1289)
!1292 = !DILocation(line: 246, column: 58, scope: !1289)
...
!1331 = !DILocation(line: 248, column: 75, scope: !1330)
!1332 = !DILocation(line: 249, column: 74, scope: !1330)
!1333 = !DILocation(line: 246, column: 58, scope: !1330)
...
!1373 = !DILocation(line: 248, column: 75, scope: !1372)
!1374 = !DILocation(line: 249, column: 74, scope: !1372)
!1375 = !DILocation(line: 246, column: 58, scope: !1372)
...
!1415 = !DILocation(line: 248, column: 75, scope: !1414)
!1416 = !DILocation(line: 249, column: 74, scope: !1414)
!1417 = !DILocation(line: 246, column: 58, scope: !1414)
...
!1447 = !DILocation(line: 288, column: 75, scope: !1446)
!1448 = !DILocation(line: 286, column: 76, scope: !1446)
!1449 = !DILocation(line: 286, column: 114, scope: !1446)
...
!1467 = !DILocation(line: 290, column: 75, scope: !1466)
!1468 = !DILocation(line: 286, column: 76, scope: !1466)
!1469 = !DILocation(line: 286, column: 114, scope: !1466)
...
!1488 = !DILocation(line: 288, column: 75, scope: !1487)
!1489 = !DILocation(line: 289, column: 75, scope: !1487)
!1490 = !DILocation(line: 286, column: 76, scope: !1487)
!1491 = !DILocation(line: 286, column: 114, scope: !1487)
...
!1519 = !DILocation(line: 288, column: 75, scope: !1518)
!1520 = !DILocation(line: 286, column: 76, scope: !1518)
!1521 = !DILocation(line: 286, column: 114, scope: !1518)
...
!1539 = !DILocation(line: 290, column: 75, scope: !1538)
!1540 = !DILocation(line: 286, column: 76, scope: !1538)
!1541 = !DILocation(line: 286, column: 114, scope: !1538)
...
!1561 = !DILocation(line: 288, column: 75, scope: !1560)
!1562 = !DILocation(line: 289, column: 75, scope: !1560)
!1563 = !DILocation(line: 286, column: 76, scope: !1560)
!1564 = !DILocation(line: 286, column: 114, scope: !1560)
...
!1592 = !DILocation(line: 288, column: 75, scope: !1591)
!1593 = !DILocation(line: 286, column: 76, scope: !1591)
!1594 = !DILocation(line: 286, column: 114, scope: !1591)
...
!1612 = !DILocation(line: 290, column: 75, scope: !1611)
!1613 = !DILocation(line: 286, column: 76, scope: !1611)
!1614 = !DILocation(line: 286, column: 114, scope: !1611)
...
!1632 = !DILocation(line: 288, column: 75, scope: !1631)
!1633 = !DILocation(line: 289, column: 75, scope: !1631)
!1634 = !DILocation(line: 286, column: 76, scope: !1631)
!1635 = !DILocation(line: 286, column: 114, scope: !1631)
...
!1664 = !DILocation(line: 288, column: 75, scope: !1663)
!1665 = !DILocation(line: 286, column: 76, scope: !1663)
!1666 = !DILocation(line: 286, column: 114, scope: !1663)
...
!1693 = !DILocation(line: 288, column: 75, scope: !1692)
!1694 = !DILocation(line: 289, column: 75, scope: !1692)
!1695 = !DILocation(line: 286, column: 76, scope: !1692)
!1696 = !DILocation(line: 286, column: 114, scope: !1692)
...
!1733 = !DILocation(line: 288, column: 75, scope: !1732)
!1734 = !DILocation(line: 286, column: 76, scope: !1732)
!1735 = !DILocation(line: 286, column: 114, scope: !1732)
...
!1753 = !DILocation(line: 290, column: 75, scope: !1752)
!1754 = !DILocation(line: 286, column: 76, scope: !1752)
!1755 = !DILocation(line: 286, column: 114, scope: !1752)
...
!1774 = !DILocation(line: 288, column: 75, scope: !1773)
!1775 = !DILocation(line: 289, column: 75, scope: !1773)
!1776 = !DILocation(line: 286, column: 76, scope: !1773)
!1777 = !DILocation(line: 286, column: 114, scope: !1773)
...
!1814 = !DILocation(line: 288, column: 75, scope: !1813)
!1815 = !DILocation(line: 286, column: 76, scope: !1813)
!1816 = !DILocation(line: 286, column: 114, scope: !1813)
...
!1834 = !DILocation(line: 290, column: 75, scope: !1833)
!1835 = !DILocation(line: 286, column: 76, scope: !1833)
!1836 = !DILocation(line: 286, column: 114, scope: !1833)
...
!1852 = !DILocation(line: 288, column: 75, scope: !1851)
!1853 = !DILocation(line: 289, column: 75, scope: !1851)
!1854 = !DILocation(line: 286, column: 76, scope: !1851)
!1855 = !DILocation(line: 286, column: 114, scope: !1851)
...
!1893 = !DILocation(line: 310, column: 74, scope: !1892)
!1894 = !DILocation(line: 308, column: 76, scope: !1892)
!1895 = !DILocation(line: 308, column: 114, scope: !1892)
...
!1934 = !DILocation(line: 339, column: 74, scope: !1933)
!1935 = !DILocation(line: 337, column: 85, scope: !1933)
...
!1949 = !DILocation(line: 338, column: 74, scope: !1947)
!1950 = !DILocation(line: 336, column: 85, scope: !1947)
...
!2029 = !DILocation(line: 410, column: 74, scope: !2028)
!2030 = !DILocation(line: 408, column: 58, scope: !2028)
...
!2046 = !DILocation(line: 409, column: 74, scope: !2044)
!2047 = !DILocation(line: 407, column: 58, scope: !2044)
...
!2093 = !DILocation(line: 410, column: 74, scope: !2092)
!2094 = !DILocation(line: 408, column: 58, scope: !2092)
...
!2110 = !DILocation(line: 409, column: 74, scope: !2108)
!2111 = !DILocation(line: 407, column: 58, scope: !2108)
...
!2157 = !DILocation(line: 410, column: 74, scope: !2156)
!2158 = !DILocation(line: 408, column: 58, scope: !2156)
...
!2173 = !DILocation(line: 409, column: 74, scope: !2171)
!2174 = !DILocation(line: 407, column: 58, scope: !2171)
...
!2219 = !DILocation(line: 410, column: 74, scope: !2218)
!2220 = !DILocation(line: 408, column: 58, scope: !2218)
...
!2235 = !DILocation(line: 409, column: 74, scope: !2233)
!2236 = !DILocation(line: 407, column: 58, scope: !2233)
...
!2281 = !DILocation(line: 410, column: 74, scope: !2280)
!2282 = !DILocation(line: 408, column: 58, scope: !2280)
...
!2297 = !DILocation(line: 409, column: 74, scope: !2295)
!2298 = !DILocation(line: 407, column: 58, scope: !2295)
...
!2345 = !DILocation(line: 440, column: 75, scope: !2344)
!2346 = !DILocation(line: 438, column: 58, scope: !2344)
...
!2361 = !DILocation(line: 439, column: 75, scope: !2359)
!2362 = !DILocation(line: 437, column: 58, scope: !2359)
...
!2407 = !DILocation(line: 440, column: 75, scope: !2406)
!2408 = !DILocation(line: 438, column: 58, scope: !2406)
...
!2423 = !DILocation(line: 439, column: 75, scope: !2421)
!2424 = !DILocation(line: 437, column: 58, scope: !2421)
...
!2469 = !DILocation(line: 440, column: 75, scope: !2468)
!2470 = !DILocation(line: 438, column: 58, scope: !2468)
...
!2485 = !DILocation(line: 439, column: 75, scope: !2483)
!2486 = !DILocation(line: 437, column: 58, scope: !2483)
...
!2795 = !DILocation(line: 687, column: 75, scope: !2794)
!2796 = !DILocation(line: 685, column: 76, scope: !2794)
!2797 = !DILocation(line: 685, column: 114, scope: !2794)
...
!2817 = !DILocation(line: 708, column: 75, scope: !2816)
!2818 = !DILocation(line: 706, column: 76, scope: !2816)
!2819 = !DILocation(line: 706, column: 114, scope: !2816)
...
!2848 = !DILocation(line: 729, column: 75, scope: !2847)
!2849 = !DILocation(line: 727, column: 76, scope: !2847)
!2850 = !DILocation(line: 727, column: 114, scope: !2847)
...
!2879 = !DILocation(line: 750, column: 75, scope: !2878)
!2880 = !DILocation(line: 748, column: 76, scope: !2878)
!2881 = !DILocation(line: 748, column: 114, scope: !2878)
...
!2901 = !DILocation(line: 771, column: 75, scope: !2900)
!2902 = !DILocation(line: 769, column: 76, scope: !2900)
!2903 = !DILocation(line: 769, column: 114, scope: !2900)
...
!2923 = !DILocation(line: 792, column: 75, scope: !2922)
!2924 = !DILocation(line: 790, column: 76, scope: !2922)
!2925 = !DILocation(line: 790, column: 114, scope: !2922)
...
!2945 = !DILocation(line: 814, column: 75, scope: !2944)
!2946 = !DILocation(line: 812, column: 76, scope: !2944)
!2947 = !DILocation(line: 812, column: 114, scope: !2944)
...
!2965 = !DILocation(line: 816, column: 75, scope: !2964)
!2966 = !DILocation(line: 812, column: 76, scope: !2964)
!2967 = !DILocation(line: 812, column: 114, scope: !2964)
...
!2985 = !DILocation(line: 814, column: 75, scope: !2984)
!2986 = !DILocation(line: 815, column: 75, scope: !2984)
!2987 = !DILocation(line: 812, column: 76, scope: !2984)
!2988 = !DILocation(line: 812, column: 114, scope: !2984)
...
!3024 = !DILocation(line: 836, column: 75, scope: !3023)
!3025 = !DILocation(line: 834, column: 76, scope: !3023)
!3026 = !DILocation(line: 834, column: 114, scope: !3023)
...
!3044 = !DILocation(line: 838, column: 75, scope: !3043)
!3045 = !DILocation(line: 834, column: 76, scope: !3043)
!3046 = !DILocation(line: 834, column: 114, scope: !3043)
...
!3064 = !DILocation(line: 836, column: 75, scope: !3063)
!3065 = !DILocation(line: 837, column: 75, scope: !3063)
!3066 = !DILocation(line: 834, column: 76, scope: !3063)
!3067 = !DILocation(line: 834, column: 114, scope: !3063)
...
!3103 = !DILocation(line: 860, column: 75, scope: !3102)
!3104 = !DILocation(line: 856, column: 76, scope: !3102)
!3105 = !DILocation(line: 856, column: 114, scope: !3102)
...
!3123 = !DILocation(line: 858, column: 75, scope: !3122)
!3124 = !DILocation(line: 859, column: 75, scope: !3122)
!3125 = !DILocation(line: 856, column: 76, scope: !3122)
!3126 = !DILocation(line: 856, column: 114, scope: !3122)
...
!3153 = !DILocation(line: 880, column: 75, scope: !3152)
!3154 = !DILocation(line: 878, column: 76, scope: !3152)
!3155 = !DILocation(line: 878, column: 114, scope: !3152)
...
!3182 = !DILocation(line: 880, column: 75, scope: !3181)
!3183 = !DILocation(line: 881, column: 75, scope: !3181)
!3184 = !DILocation(line: 878, column: 76, scope: !3181)
!3185 = !DILocation(line: 878, column: 114, scope: !3181)
...
!3277 = !DILocation(line: 973, column: 83, scope: !3276)
!3278 = !DILocation(line: 972, column: 23, scope: !3276)
