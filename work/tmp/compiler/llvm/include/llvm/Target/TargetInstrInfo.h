...
public:
  ...
  /// in the function.
  /// =================== CODASIP =========================
  /// Adds the option to turn off rematerializabiliy of a specific instr.
  /// RISC-V doesn't schedule correctly due to this flag during RA.
  /// At that point, we don't know that the flag is incorrect yet.
  /// For now, It's only overriden in the RISC-V model in CodasipInstrInfo
  virtual
  /// ======================================================
