...
public:
  ...
  // ==== CODASIP ======
  virtual CodasipBaseHooks *getHooks() const {
      //assert(false && "Only overridden version can be called");
      return nullptr;
  }
  // we need our own cfi printer modificator
  virtual bool hasCodasipCFI() const {
     return false;
  }
  // the following method is used in LLC extractor
  const DataLayout &getDataLayout() const { return DL; }
  // getNameWithPrefix needs to be virtual
  virtual
  // ===================
