...
namespace llvm {
  ...
  public:
    ...
    {
      return isSimple() && getSimpleVT().isOriginal();
    }
    //========================================
    ...
    EVT getHalfSizedIntegerVT(LLVMContext &Context) const {
      ...
      for (unsigned IntVT = MVT::FIRST_INTEGER_VALUETYPE;
          //========================= CODASIP =========================
          // make sure to iterate also over custom types
          IntVT <= MVT::LAST_CUSTOM_INTEGER_VALUETYPE; ++IntVT) {
          if (!MVT((MVT::SimpleValueType)IntVT).isInteger()
              || MVT((MVT::SimpleValueType)IntVT).isVector()) continue;
          //=========================================================
          #if 0
        ...
        //========================= CODASIP =========================
        /* Division of custom types is not correct */
        if (isOriginal()) {
        //===========================================================
