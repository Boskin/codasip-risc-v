...
namespace ISD {
  ...
  //================ CODASIP ==================
  /* Some models may have so many extra nodes and moi nodes
   * that this constant is not enough. If moi nodes have opcodes more
   * than this constant, they are considered memory nodes and that
   * leads to segfault */
  static const int FIRST_TARGET_MEMORY_OPCODE = BUILTIN_OP_END+1800;
  //===========================================
  #if 0
