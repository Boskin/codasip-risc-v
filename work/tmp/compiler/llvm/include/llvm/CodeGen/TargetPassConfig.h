...
public:
  ...
  // ============ CODASIP ==================
  /// addSuperBlockPreRegAlloc - This method should add some special passes
  /// before register allocation pass, but after Process Imlicit Definitions
  /// pass.
  virtual bool addSuperBlockPreRegAlloc() {
    return false;
  }
  // =======================================
