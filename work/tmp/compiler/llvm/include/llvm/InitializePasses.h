...
// ======== CODASIP ========
#ifdef CODASIPAA
void initializeImAndersensPass(PassRegistry&);
#endif
void initializeCoalesFixerPass(PassRegistry&);
void initializeStripDeadDefinitionsPass(PassRegistry&);
void initializeModuloSchedulingPass(PassRegistry&);
void initializeModSchedFinalizerPass(PassRegistry&);
void initializeRegisterSanitizerPass(PassRegistry&);
void initializeSuperBlockSchedulingPass(PassRegistry&);
// =========================
}
