# 1 "C:\\Codasip\\Studio-6.8.2\\tools\\toolchain\\newlib\\newlib\\libc\\stdlib\\wcsrtombs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 292 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:\\Codasip\\Studio-6.8.2\\tools\\toolchain\\newlib\\newlib\\libc\\stdlib\\wcsrtombs.c" 2
...
size_t
_wcsrtombs_r(struct _reent *r , char *dst , const wchar_t **src , size_t len , mbstate_t *ps)
...
{
  return _wcsnrtombs_r (_impure_ptr, dst, src, (size_t) -1, len, ps);
}
