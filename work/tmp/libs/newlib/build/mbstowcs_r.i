# 1 "C:\\Codasip\\Studio-6.8.2\\tools\\toolchain\\newlib\\newlib\\libc\\stdlib\\mbstowcs_r.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 292 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:\\Codasip\\Studio-6.8.2\\tools\\toolchain\\newlib\\newlib\\libc\\stdlib\\mbstowcs_r.c" 2
...
size_t
_mbstowcs_r(struct _reent *r , wchar_t *restrict pwcs , const char *restrict s , size_t n , mbstate_t *state)
...

{
  ...
  while (n > 0)
    {
      bytes = __mbtowc (r, pwcs, t, __locale_mb_cur_max(), __locale_charset (), state);
      if (bytes < 0)
 {
   state->__count = 0;
   return -1;
